...
;       →→→ §4.1.5: DisplaySplashText(…).......................................................132
;       →→→ §4.1.6: FallbackWinActivate(…).....................................................140
;       →→→ §4.1.7: GetActiveWindowBorderWidths()..............................................158
;       →→→ §4.1.8: GetCursorCoordsToCenterInActiveWindow()....................................176
;       →→→ §4.1.9: GetWindowBorderWidths(…)...................................................186
;       →→→ §4.1.10: InsertFilePath............................................................205
;       →→→ §4.1.11: LaunchApplicationPatiently................................................234
;       →→→ §4.1.12: LaunchStdApplicationPatiently.............................................266
;       →→→ §4.1.13: MoveCursorIntoActiveWindow................................................298
;       →→→ §4.1.14: PasteText.................................................................316
;       →→→ §4.1.15: RemoveMinMaxStateForActiveWin.............................................327
;       →→→ §4.1.16: SafeWinActivate...........................................................339
;       →→→ §4.1.17: WaitForApplicationPatiently...............................................368
;       →→→ §4.1.18: WriteCodeToFile...........................................................389
;     >>> §4.2: Hotkeys........................................................................417
;       →→→ §4.2.1: ^+F1, ^!Numpad1............................................................421
;       →→→ §4.2.2: ^+F2, ^!Numpad2............................................................430
;       →→→ §4.2.3: ^!q........................................................................441
;     >>> §4.3: Hotstrings.....................................................................451
;       →→→ §4.3.1: @getMousePos...............................................................454
;       →→→ §4.3.2: @getWinBorders.............................................................464
;       →→→ §4.3.3: @getWinExStyle.............................................................478
;       →→→ §4.3.4: @get/copyWinHwnd...........................................................488
;       →→→ §4.5.: @getWinInfo.................................................................503
;       →→→ §4.3.6: @getWinPID.................................................................530
;       →→→ §4.3.7: @getWinPos.................................................................539
;       →→→ §4.3.8: @getWinStyle...............................................................549
;       →→→ §4.3.9: @getWinProcess.............................................................559
;       →→→ §4.3.10: @get/copyWinTitle.........................................................571
;   §5: AutoHotkey state inquiry and manipulation..............................................586
;     >>> §5.1: Functions......................................................................592
;       →→→ §5.1.1: ChangeMatchMode............................................................595
;       →→→ §5.1.2: ChangeMouseCoordMode.......................................................614
;       →→→ §5.1.3: GetDelay...................................................................632
;       →→→ §5.1.4: RestoreMatchMode...........................................................682
;       →→→ §5.1.5: RestoreMouseCoordMode......................................................698
;     >>> §5.2: Hotstrings.....................................................................713
;       →→→ §5.2.1: @checkIsUnicode............................................................716
;       →→→ §5.2.2: @getCurrentVersion.........................................................725
;       →→→ §5.2.3: @getLastHotStrTime.........................................................733
;   §6: Sorting functions......................................................................741
;     >>> §6.1: InsertionSort..................................................................745
;     >>> §6.2: Merge..........................................................................771
;     >>> §6.3: MergeSort......................................................................797
;     >>> §6.4: SwapValues.....................................................................813
;   §7: Desktop management functions...........................................................822
; ==================================================================================================
...
DisplaySplashProgress( normProg, mainText := "Progress for current operation" ) {
	if ( normProg == 0 ) {
		Progress, y320, , %mainText%, %A_ScriptName%
	} else {
		Progress, %normProg%
	}
	if ( normProg >= 100 ) {
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §4.1.17: WaitForApplicationPatiently
