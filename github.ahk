...
;     >>> §1.1: GetCmdForMoveToCSSFolder.......................................................262
;     >>> §1.2: GetCurrentDirFrom..............................................................277
;     >>> §1.3: GetGitHubFolder................................................................289
;     >>> §1.4: UserFolderIsSet................................................................297
;   §2: FUNCTIONS for working with GitHub Desktop..............................................311
;     >>> §2.1: ActivateGitShell...............................................................315
;     >>> §2.2: CommitAfterBuild...............................................................334
;     >>> §2.3: EscapeCommitMessage............................................................369
...
;     >>> §2.5: CopySrcFileToClipboard.........................................................397
;     >>> §2.6: IsGitShellActive...............................................................418
;     >>> §2.7: PasteTextIntoGitShell..........................................................425
;     >>> §2.8: ToEscapedPath..................................................................451
;     >>> §2.9: VerifyCopiedCode...............................................................459
;   §3: FUNCTIONS for interacting with online WEB DESIGN INTERFACES............................473
;     >>> §3.1: LoadWordPressSiteInChrome......................................................477
;   §4: GUI FUNCTIONS for handling user interactions with scripts..............................513
;     >>> §4.1: @postMinCss....................................................................517
;       →→→ §4.1.1: HandlePostCssCheckAllSites.................................................557
;       →→→ §4.1.2: HandlePostCssUncheckAllSites...............................................577
;       →→→ §4.1.3: HandlePostMinCssCancel.....................................................597
;       →→→ §4.1.4: HandlePostMinCssOK.........................................................604
;       →→→ §4.1.5: PasteMinCssToWebsite.......................................................671
;     >>> §4.2: @postBackupCss.................................................................682
;       →→→ §4.2.1: HandlePostBackupCssCheckAllSites...........................................727
;       →→→ §4.2.2: HandlePostBackupCssUncheckAllSites.........................................747
;       →→→ §4.2.3: HandlePostBackupCssCancel..................................................767
;       →→→ §4.2.4: HandlePostBackupCssOK......................................................774
;     >>> §4.3: @postMinJs.....................................................................837
;       →→→ §4.3.1: HandlePostJsCheckAllSites..................................................888
;       →→→ §4.3.2: HandlePostJsUncheckAllSites................................................908
;       →→→ §4.3.3: HandlePostMinJsCancel......................................................928
;       →→→ §4.3.4: HandlePostMinJsOK..........................................................935
;       →→→ §4.3.5: PasteMinJsToWebsite.......................................................1002
;   §5: UTILITY HOTSTRINGS for working with GitHub Desktop....................................1017
;     >>> §5.1: FILE COMMITTING...............................................................1021
;     >>> §5.2: STATUS CHECKING...............................................................1171
;       →→→ §5.2.1: @doGitStataus & @dogs.....................................................1174
;       →→→ §5.2.2: @doGitDiff & @dogd........................................................1194
;       →→→ §5.2.3: @doGitLog & @dogl.........................................................1214
;     >>> §5.3: Automated PASTING OF CSS/JS into online web interfaces........................1235
;       →→→ §5.3.1: @initCssPaste.............................................................1238
;       →→→ §5.3.2: @doCssPaste...............................................................1266
;       →→→ §5.3.3: @pasteGitCommitMsg........................................................1327
;       →→→ §5.3.4: ExecuteCssPasteCmds.......................................................1343
;       →→→ §5.3.5: ExecuteJsPasteCmds........................................................1377
;   §6: COMMAND LINE INPUT GENERATION SHORTCUTS...............................................1418
;     >>> §6.1: Shortucts for backing up custom CSS builds....................................1422
;       →→→ §6.1.1: @BackupCss................................................................1425
;       →→→ §6.1.2: @backupCssAscc............................................................1438
;       →→→ §6.1.3: @backupCssCr..............................................................1447
;       →→→ §6.1.4: @backupCssDsp.............................................................1456
;       →→→ §6.1.5: @backupCssFye.............................................................1465
;       →→→ §6.1.6: @backupCssFyf.............................................................1482
;       →→→ §6.1.7: @backupCssNse.............................................................1500
;       →→→ §6.1.8: @backupCssOue.............................................................1517
;       →→→ §6.1.9: @backupCssPbk.............................................................1534
;       →→→ §6.1.10: @backupCssSurca..........................................................1551
;       →→→ §6.1.11: @backupCssSumRes.........................................................1568
;       →→→ §6.1.12: @backupCssXfer...........................................................1586
;       →→→ §6.1.13: @backupCssUgr............................................................1604
;       →→→ §6.1.14: @backupCssXfer...........................................................1614
;       →→→ §6.1.15: @backupCssUcrAss.........................................................1631
;       →→→ §6.1.16: @backupCssAll............................................................1649
;       →→→ §6.1.17: CopyCssFromWebsite.......................................................1672
;       →→→ §6.1.18: ExecuteCssCopyCmds.......................................................1682
;     >>> §6.2: Shortcuts for rebuilding & committing custom CSS files........................1701
;       →→→ §6.2.1: @rebuildCssHere...........................................................1704
;       →→→ §6.2.2: @rebuildCssAscc...........................................................1714
;       →→→ §6.2.3: @commitCssAscc............................................................1726
;       →→→ §6.2.4: @rebuildCssCr.............................................................1741
;       →→→ §6.2.5: @commitCssCr..............................................................1753
;       →→→ §6.2.6: @rebuildCssDsp............................................................1768
;       →→→ §6.2.7: @commitCssDsp.............................................................1780
;       →→→ §6.2.8: @rebuildCssFye............................................................1795
;       →→→ §6.2.9: @commitCssFye.............................................................1807
;       →→→ §6.2.10: @rebuildCssFyf...........................................................1823
;       →→→ §6.2.11: @commitCssFyf............................................................1835
;       →→→ §6.2.12: @rebuildCssNse...........................................................1848
;       →→→ §6.2.13: @commitCssNse............................................................1860
;       →→→ §6.2.14: @rebuildCssOue...........................................................1875
;       →→→ §6.2.15: @commitCssOue............................................................1887
;       →→→ §6.2.16: @rebuildCssPbk...........................................................1903
;       →→→ §6.2.17: @commitCssPbk............................................................1915
;       →→→ §6.2.18: @rebuildCssSurca.........................................................1931
;       →→→ §6.2.19: @commitCssSurca..........................................................1943
;       →→→ §6.2.20: @rebuildCssSumRes........................................................1958
;       →→→ §6.2.21: @commitCssSumRes.........................................................1970
;       →→→ §6.2.22: @rebuildCssXfer..........................................................1985
;       →→→ §6.2.23: @commitCssXfer...........................................................1997
;       →→→ §6.2.24: @rebuildCssUgr...........................................................2013
;       →→→ §6.2.25: @commitCssUgr............................................................2025
;       →→→ §6.2.26: @rebuildCssUcore.........................................................2040
;       →→→ §6.2.27: @commitCssUcore..........................................................2052
;       →→→ §6.2.28: @rebuildCssUcrAss........................................................2067
;       →→→ §6.2.29: @commitCssUcrAss.........................................................2079
;       →→→ §6.2.30: @rebuildCssAll...........................................................2094
;     >>> §6.3: Shortcuts for updating CSS submodules.........................................2119
;       →→→ §6.3.1: UpdateCssSubmodule........................................................2122
;       →→→ §6.3.2: @updateCssSubmoduleAscc...................................................2141
;       →→→ §6.3.3: @updateCssSubmoduleCr.....................................................2148
;       →→→ §6.3.4: @updateCssSubmoduleDsp....................................................2155
;       →→→ §6.3.5: @updateCssSubmoduleFye....................................................2162
;       →→→ §6.3.6: @updateCssSubmoduleFyf....................................................2169
;       →→→ §6.3.7: @updateCssSubmoduleNse....................................................2176
;       →→→ §6.3.8: @updateCssSubmoduleOue....................................................2183
;       →→→ §6.3.9: @updateCssSubmodulePbk....................................................2190
;       →→→ §6.3.10: @updateCssSubmoduleSurca.................................................2197
;       →→→ §6.3.11: @updateCssSubmoduleSumRes................................................2204
;       →→→ §6.3.12: @updateCssSubmoduleXfer..................................................2211
;       →→→ §6.3.13: @updateCssSubmoduleUgr...................................................2218
;       →→→ §6.3.14: @updateCssSubmoduleUcore.................................................2225
;       →→→ §6.3.15: @updateCssSubmoduleUcrAss................................................2232
;       →→→ §6.3.16: @updateCssSubmoduleAll...................................................2239
;     >>> §6.4: For copying minified, backup css files to clipboard...........................2265
;       →→→ §6.4.1: @copyMinCssAscc...........................................................2268
;       →→→ §6.4.2: @copyBackupCssAscc........................................................2278
;       →→→ §6.4.3: @copyMinCssCr.............................................................2288
;       →→→ §6.4.4: @copyBackupCssCr..........................................................2298
;       →→→ §6.4.5: @copyMinCssDsp............................................................2308
;       →→→ §6.4.6: @copyBackupCssDsp.........................................................2318
;       →→→ §6.4.7: @copyMinCssFye............................................................2328
;       →→→ §6.4.8: @copyBackupCssFye.........................................................2340
;       →→→ §6.4.9: @copyMinCssFyf............................................................2350
;       →→→ §6.4.10: @copyBackupCssFyf........................................................2360
;       →→→ §6.4.11: @copyMinCssNse...........................................................2370
;       →→→ §6.4.12: @copyBackupCssNse........................................................2380
;       →→→ §6.4.13: @copyMinCssOue...........................................................2390
;       →→→ §6.4.14: @copyMinCssPbk...........................................................2400
;       →→→ §6.4.15: @copyBackupCssPbk........................................................2410
;       →→→ §6.4.16: @copyMinCssSurca.........................................................2420
;       →→→ §6.4.17: @copyBackupCssSurca......................................................2430
;       →→→ §6.4.18: @copyMinCssSumRes........................................................2440
;       →→→ §6.4.19: @copyBackupCssSumRes.....................................................2450
;       →→→ §6.4.20: @copyMinCssXfer..........................................................2460
;       →→→ §6.4.21: @copyBackupCssXfer.......................................................2470
;       →→→ §6.4.22: @copyMinCssUgr...........................................................2480
;       →→→ §6.4.23: @copyBackupCssUgr........................................................2491
;       →→→ §6.4.24: @copyMinCssUcore.........................................................2501
;       →→→ §6.4.25: @copyBackupCssUcore......................................................2511
;       →→→ §6.4.26: @copyMinCssUcrAss........................................................2521
;       →→→ §6.4.27: @copyBackupCssUcrAss.....................................................2531
;     >>> §6.5: FOR BACKING UP CUSTOM JS BUILDS...............................................2541
;       →→→ §6.5.1: BackupJs..................................................................2544
;       →→→ §6.5.2: @backupJsAscc.............................................................2558
;       →→→ §6.5.3: @backupJsCr...............................................................2573
;       →→→ §6.5.4: @backupJsDsp..............................................................2589
;       →→→ §6.5.5: @backupJsFye..............................................................2599
;       →→→ §6.5.6: @backupJsFyf..............................................................2615
;       →→→ §6.5.7: @backupJsNse..............................................................2631
;       →→→ §6.5.8: @backupJsOue..............................................................2645
;       →→→ §6.5.9: @backupJsPbk..............................................................2659
;       →→→ §6.5.10: @backupJsSurca...........................................................2675
;       →→→ §6.5.11: @backupJsSumRes..........................................................2690
;       →→→ §6.5.12: @commitBackupJsSumRes....................................................2702
;       →→→ §6.5.13: @backupJsXfer............................................................2714
;       →→→ §6.5.14: @backupJsUgr.............................................................2724
;       →→→ §6.5.15: @backupJsUcore...........................................................2734
;       →→→ §6.5.16: @backupJsUcrAss..........................................................2749
;       →→→ §6.5.17: @backupJsAll.............................................................2765
;       →→→ §6.5.18: CopyJsFromWebsite........................................................2791
;       →→→ §6.5.19: ExecuteJsCopyCmds........................................................2802
;     >>> §6.6: FOR REBUILDING JS SOURCE FILES................................................2818
;       →→→ §6.6.1: RebuildJs.................................................................2821
;       →→→ §6.6.2: @rebuildJsAscc............................................................2832
;       →→→ §6.6.3: @rebuildJsCr..............................................................2839
;       →→→ §6.6.4: @rebuildJsDsp.............................................................2846
;       →→→ §6.6.5: @rebuildJsFye.............................................................2853
;       →→→ §6.6.6: @rebuildJsFyf.............................................................2872
;       →→→ §6.6.7: @rebuildJsNse.............................................................2891
;       →→→ §6.6.8: @rebuildJsOue.............................................................2910
;       →→→ §6.6.9: @rebuildJsPbk.............................................................2917
;       →→→ §6.6.10: @rebuildJsSurca..........................................................2936
;       →→→ §6.6.11: @rebuildJsSumRes.........................................................2943
;       →→→ §6.6.12: @rebuildJsXfer...........................................................2955
;       →→→ §6.6.13: @rebuildJsUgr............................................................2962
;       →→→ §6.6.14: @rebuildJsUcore..........................................................2974
;       →→→ §6.6.15: @rebuildJsUcrAss.........................................................2987
;     >>> §6.7: FOR UPDATING JS SUBMODULES....................................................3006
;       →→→ §6.7.1: @commitJsAscc.............................................................3009
;       →→→ §6.7.2: @commitJsCr,..............................................................3018
;       →→→ §6.7.3: @commitJsDsp..............................................................3027
;       →→→ §6.7.4: @commitJsOue..............................................................3036
;       →→→ §6.7.5: @commitJsSurca............................................................3044
;       →→→ §6.7.6: @commitJsSumRes...........................................................3053
;       →→→ §6.7.7: @commitJsXfer.............................................................3062
;       →→→ §6.7.8: @commitJsUgr..............................................................3071
;       →→→ §6.7.9: @commitJsUcore............................................................3080
;       →→→ §6.7.10: @commitJsXfer............................................................3089
;     >>> §6.8: FOR UPDATING JS SUBMODULES....................................................3097
;       →→→ §6.8.1: UpdateJsSubmodule.........................................................3100
;       →→→ §6.8.2: @updateJsSubmoduleAscc....................................................3119
;       →→→ §6.8.3: @updateJsSubmoduleCr......................................................3126
;       →→→ §6.8.4: @updateJsSubmoduleDsp.....................................................3134
;       →→→ §6.8.5: @updateJsSubmoduleFye.....................................................3142
;       →→→ §6.8.6: @updateJsSubmoduleFyf.....................................................3149
;       →→→ §6.8.7: @updateJsSubmoduleNse.....................................................3157
;       →→→ §6.8.8: @updateJsSubmoduleOue.....................................................3164
;       →→→ §6.8.9: @updateJsSubmodulePbk.....................................................3171
;       →→→ §6.8.10: @updateJsSubmoduleSurca..................................................3178
;       →→→ §6.8.11: @updateJsSubmoduleSumRes.................................................3185
;       →→→ §6.8.12: @updateJsSubmoduleXfer...................................................3193
;       →→→ §6.8.13: @updateJsSubmoduleUgr....................................................3201
;       →→→ §6.8.14: @updateJsSubmoduleUcore..................................................3208
;       →→→ §6.8.15: @updateJsSubmoduleUcrAss.................................................3215
;       →→→ §6.8.16: @updateJsSubmoduleAll....................................................3223
;     >>> §6.9: Shortcuts for copying minified JS to clipboard................................3250
;       →→→ §6.9.1: @copyMinJsAscc............................................................3255
;       →→→ §6.9.2: @copyMinJsCr..............................................................3266
;       →→→ §6.9.3: @copyMinJsDsp.............................................................3277
;       →→→ §6.9.4: @copyMinJsFye.............................................................3288
;       →→→ §6.9.5: @copyMinJsFyf.............................................................3299
;       →→→ §6.9.6: @copyMinJsNse.............................................................3310
;       →→→ §6.9.7: @copyMinJsOue.............................................................3321
;       →→→ §6.9.8: @copyBackupJsOue..........................................................3332
;       →→→ §6.9.9: @copyMinJsPbk.............................................................3343
;       →→→ §6.9.10: @copyMinJsSurca..........................................................3354
;       →→→ §6.9.11: @copyMinJsSumRes.........................................................3365
;       →→→ §6.9.12: @copyMinJsXfer...........................................................3376
;       →→→ §6.9.13: @copyMinJsUgr............................................................3386
;       →→→ §6.9.14: @copyMinJsUcore..........................................................3396
;       →→→ §6.9.15: @copyBackupJsUcore.......................................................3407
;       →→→ §6.9.16: @copyMinJsUcrAss.........................................................3418
;     >>> §6.10: FOR CHECKING GIT STATUS ON ALL PROJECTS .....................................3429
;   §7: KEYBOARD SHORTCUTS FOR POWERSHELL.....................................................3515
;     >>> §7.1: SHORTCUTS.....................................................................3519
;     >>> §7.2: SUPPORTING FUNCTIONS..........................................................3546
; ==================================================================================================
