...
; Table of Contents
; -----------------
;   §1: SETTINGS accessed via functions for this imported file.................................249
;     >>> §1.1: GetCmdForMoveToCSSFolder.......................................................253
;     >>> §1.2: GetCurrentDirFrom..............................................................268
;     >>> §1.3: GetGitHubFolder................................................................280
;     >>> §1.4: UserFolderIsSet................................................................288
;   §2: FUNCTIONS for working with GitHub Desktop..............................................302
;     >>> §2.1: ActivateGitShell...............................................................306
;     >>> §2.2: CommitAfterBuild...............................................................325
;     >>> §2.3: EscapeCommitMessage............................................................360
;     >>> §2.4: Git commit GUI — Imports.......................................................370
;       →→→ §2.4.1: For committing CSS builds..................................................373
;       →→→ §2.4.2: For committing JS builds...................................................378
;       →→→ §2.4.3: For committing any type of file............................................383
;     >>> §2.5: CopySrcFileToClipboard.........................................................388
;     >>> §2.6: IsGitShellActive...............................................................409
;     >>> §2.7: PasteTextIntoGitShell..........................................................418
;     >>> §2.8: ToEscapedPath..................................................................444
;     >>> §2.9: VerifyCopiedCode...............................................................452
;   §3: FUNCTIONS for interacting with online WEB DESIGN INTERFACES............................466
;     >>> §3.1: LoadWordPressSiteInChrome......................................................470
;   §4: GUI FUNCTIONS for handling user interactions with scripts..............................506
;     >>> §4.1: @postMinCss....................................................................510
;       →→→ §4.1.1: HandlePostCssCheckAllSites.................................................550
;       →→→ §4.1.2: HandlePostCssUncheckAllSites...............................................570
;       →→→ §4.1.3: HandlePostMinCssCancel.....................................................590
;       →→→ §4.1.4: HandlePostMinCssOK.........................................................597
;       →→→ §4.1.5: PasteMinCssToWebsite.......................................................664
;     >>> §4.2: @postBackupCss.................................................................675
;       →→→ §4.2.1: HandlePostBackupCssCheckAllSites...........................................720
;       →→→ §4.2.2: HandlePostBackupCssUncheckAllSites.........................................740
;       →→→ §4.2.3: HandlePostBackupCssCancel..................................................760
;       →→→ §4.2.4: HandlePostBackupCssOK......................................................767
;     >>> §4.3: @postMinJs.....................................................................830
;       →→→ §4.3.1: HandlePostJsCheckAllSites..................................................881
;       →→→ §4.3.2: HandlePostJsUncheckAllSites................................................901
;       →→→ §4.3.3: HandlePostMinJsCancel......................................................921
;       →→→ §4.3.4: HandlePostMinJsOK..........................................................928
;       →→→ §4.3.5: PasteMinJsToWebsite........................................................995
;   §5: UTILITY HOTSTRINGS for working with GitHub Desktop....................................1010
;     >>> §5.1: FILE COMMITTING...............................................................1014
;     >>> §5.2: STATUS CHECKING...............................................................1164
;       →→→ §5.2.1: @doGitStataus & @dogs.....................................................1167
;       →→→ §5.2.2: @doGitDiff & @dogd........................................................1187
;       →→→ §5.2.3: @doGitLog & @dogl.........................................................1207
;     >>> §5.3: Automated PASTING OF CSS/JS into online web interfaces........................1228
;       →→→ §5.3.1: @initCssPaste.............................................................1231
;       →→→ §5.3.2: @doCssPaste...............................................................1259
;       →→→ §5.3.3: @pasteGitCommitMsg........................................................1320
;       →→→ §5.3.4: ExecuteCssPasteCmds.......................................................1336
;       →→→ §5.3.5: ExecuteJsPasteCmds........................................................1370
;   §6: COMMAND LINE INPUT GENERATION SHORTCUTS...............................................1411
;     >>> §6.1: Shortucts for backing up custom CSS builds....................................1415
;       →→→ §6.1.1: BackupCss.................................................................1418
;       →→→ §6.1.2: @backupCssAscc............................................................1431
;       →→→ §6.1.3: @backupCssCr..............................................................1440
;       →→→ §6.1.4: @backupCssDsp.............................................................1449
;       →→→ §6.1.5: @backupCssFye.............................................................1458
;       →→→ §6.1.6: @backupCssFyf.............................................................1475
;       →→→ §6.1.7: @backupCssNse.............................................................1493
;       →→→ §6.1.8: @backupCssOue.............................................................1510
;       →→→ §6.1.9: @backupCssPbk.............................................................1527
;       →→→ §6.1.10: @backupCssSurca..........................................................1544
;       →→→ §6.1.11: @backupCssSumRes.........................................................1561
;       →→→ §6.1.12: @backupCssXfer...........................................................1579
;       →→→ §6.1.13: @backupCssUgr............................................................1597
;       →→→ §6.1.14: @backupCssXfer...........................................................1607
;       →→→ §6.1.15: @backupCssUcrAss.........................................................1624
;       →→→ §6.1.16: @backupCssAll............................................................1642
;       →→→ §6.1.17: CopyCssFromWebsite.......................................................1665
;       →→→ §6.1.18: ExecuteCssCopyCmds.......................................................1675
;     >>> §6.2: Shortcuts for rebuilding & committing custom CSS files........................1694
;       →→→ §6.2.1: @rebuildCssHere...........................................................1697
;       →→→ §6.2.2: @rebuildCssAscc...........................................................1707
;       →→→ §6.2.3: @commitCssAscc............................................................1719
;       →→→ §6.2.4: @rebuildCssCr.............................................................1734
;       →→→ §6.2.5: @commitCssCr..............................................................1746
;       →→→ §6.2.6: @rebuildCssDsp............................................................1761
;       →→→ §6.2.7: @commitCssDsp.............................................................1773
;       →→→ §6.2.8: @rebuildCssFye............................................................1788
;       →→→ §6.2.9: @commitCssFye.............................................................1800
;       →→→ §6.2.10: @rebuildCssFyf...........................................................1816
;       →→→ §6.2.11: @commitCssFyf............................................................1828
;       →→→ §6.2.12: @rebuildCssNse...........................................................1841
;       →→→ §6.2.13: @commitCssNse............................................................1853
;       →→→ §6.2.14: @rebuildCssOue...........................................................1868
;       →→→ §6.2.15: @commitCssOue............................................................1880
;       →→→ §6.2.16: @rebuildCssPbk...........................................................1896
;       →→→ §6.2.17: @commitCssPbk............................................................1908
;       →→→ §6.2.18: @rebuildCssSurca.........................................................1924
;       →→→ §6.2.19: @commitCssSurca..........................................................1936
;       →→→ §6.2.20: @rebuildCssSumRes........................................................1951
;       →→→ §6.2.21: @commitCssSumRes.........................................................1963
;       →→→ §6.2.22: @rebuildCssXfer..........................................................1978
;       →→→ §6.2.23: @commitCssXfer...........................................................1990
;       →→→ §6.2.24: @rebuildCssUgr...........................................................2006
;       →→→ §6.2.25: @commitCssUgr............................................................2018
;       →→→ §6.2.26: @rebuildCssUcore.........................................................2033
;       →→→ §6.2.27: @commitCssUcore..........................................................2045
;       →→→ §6.2.28: @rebuildCssUcrAss........................................................2060
;       →→→ §6.2.29: @commitCssUcrAss.........................................................2072
;       →→→ §6.2.30: @rebuildCssAll...........................................................2087
;     >>> §6.3: Shortcuts for updating CSS submodules.........................................2112
;       →→→ §6.3.1: @updateCssSubmoduleAscc...................................................2115
;       →→→ §6.3.2: @updateCssSubmoduleCr.....................................................2132
;       →→→ §6.3.3: @updateCssSubmoduleDsp....................................................2149
;       →→→ §6.3.4: @updateCssSubmoduleFye....................................................2166
;       →→→ §6.3.5: @updateCssSubmoduleFyf....................................................2183
;       →→→ §6.3.6: @updateCssSubmoduleNse....................................................2200
;       →→→ §6.3.7: @updateCssSubmoduleOue....................................................2217
;       →→→ §6.3.8: @updateCssSubmodulePbk....................................................2234
;       →→→ §6.3.9: @updateCssSubmoduleSurca..................................................2251
;       →→→ §6.3.10: @updateCssSubmoduleSumRes................................................2268
;       →→→ §6.3.11: @updateCssSubmoduleXfer..................................................2285
;       →→→ §6.3.12: @updateCssSubmoduleUgr...................................................2302
;       →→→ §6.3.13: @updateCssSubmoduleUcore.................................................2319
;       →→→ §6.3.14: @updateCssSubmoduleUcrAss................................................2336
;       →→→ §6.3.15: @updateCssSubmoduleAll...................................................2353
;     >>> §6.4: For copying minified, backup css files to clipboard...........................2379
;       →→→ §6.4.1: @copyMinCssAscc...........................................................2382
;       →→→ §6.4.2: @copyBackupCssAscc........................................................2392
;       →→→ §6.4.3: @copyMinCssCr.............................................................2402
;       →→→ §6.4.4: @copyBackupCssCr..........................................................2412
;       →→→ §6.4.5: @copyMinCssDsp............................................................2422
;       →→→ §6.4.6: @copyBackupCssDsp.........................................................2432
;       →→→ §6.4.7: @copyMinCssFye............................................................2442
;       →→→ §6.4.8: @copyBackupCssFye.........................................................2454
;       →→→ §6.4.9: @copyMinCssFyf............................................................2464
;       →→→ §6.4.10: @copyBackupCssFyf........................................................2474
;       →→→ §6.4.11: @copyMinCssNse...........................................................2484
;       →→→ §6.4.12: @copyBackupCssNse........................................................2494
;       →→→ §6.4.13: @copyMinCssOue...........................................................2504
;       →→→ §6.4.14: @copyMinCssPbk...........................................................2514
;       →→→ §6.4.15: @copyBackupCssPbk........................................................2524
;       →→→ §6.4.16: @copyMinCssSurca.........................................................2534
;       →→→ §6.4.17: @copyBackupCssSurca......................................................2546
;       →→→ §6.4.18: @copyMinCssSumRes........................................................2556
;       →→→ §6.4.19: @copyBackupCssSumRes.....................................................2566
;       →→→ §6.4.20: @copyMinCssXfer..........................................................2576
;       →→→ §6.4.21: @copyBackupCssXfer.......................................................2586
;       →→→ §6.4.22: @copyMinCssUgr...........................................................2596
;       →→→ §6.4.23: @copyBackupCssUgr........................................................2607
;       →→→ §6.4.24: @copyMinCssUcore.........................................................2617
;       →→→ §6.4.25: @copyBackupCssUcore......................................................2627
;       →→→ §6.4.26: @copyMinCssUcrAss........................................................2637
;       →→→ §6.4.27: @copyBackupCssUcrAss.....................................................2647
;     >>> §6.5: FOR BACKING UP CUSTOM JS BUILDS...............................................2657
;       →→→ §6.5.1: BackupJs..................................................................2660
;       →→→ §6.5.2: @backupJsAscc.............................................................2674
;       →→→ §6.5.3: @backupJsCr...............................................................2689
;       →→→ §6.5.4: @backupJsDsp..............................................................2705
;       →→→ §6.5.5: @backupJsFye..............................................................2715
;       →→→ §6.5.6: @backupJsFyf..............................................................2731
;       →→→ §6.5.7: @backupJsNse..............................................................2747
;       →→→ §6.5.8: @backupJsOue..............................................................2761
;       →→→ §6.5.9: @backupJsPbk..............................................................2775
;       →→→ §6.5.10: @backupJsSurca...........................................................2791
;       →→→ §6.5.11: @backupJsSumRes..........................................................2806
;       →→→ §6.5.12: @commitBackupJsSumRes....................................................2818
;       →→→ §6.5.13: @backupJsXfer............................................................2830
;       →→→ §6.5.14: @backupJsUgr.............................................................2846
;       →→→ §6.5.15: @backupJsUcore...........................................................2862
;       →→→ §6.5.16: @backupJsUcrAss..........................................................2877
;       →→→ §6.5.17: @backupJsAll.............................................................2893
;       →→→ §6.5.18: CopyJsFromWebsite........................................................2919
;       →→→ §6.5.19: ExecuteJsCopyCmds........................................................2930
;     >>> §6.6: FOR REBUILDING JS SOURCE FILES................................................2946
;       →→→ §6.6.1: @rebuildJsAscc............................................................2949
;       →→→ §6.6.2: @rebuildJsCr..............................................................2968
;       →→→ §6.6.3: @rebuildJsDsp.............................................................2987
;       →→→ §6.6.4: @commitJsDsp..............................................................3002
;       →→→ §6.6.5: @rebuildJsFye.............................................................3014
;       →→→ §6.6.6: @rebuildJsFyf.............................................................3033
;       →→→ §6.6.7: @rebuildJsNse.............................................................3052
;       →→→ §6.6.8: @rebuildJsOue.............................................................3071
;       →→→ §6.6.9: @rebuildJsPbk.............................................................3090
;       →→→ §6.6.10: @rebuildJsSurca..........................................................3109
;       →→→ §6.6.11: @rebuildJsSumRes.........................................................3128
;       →→→ §6.6.12: @commitJsSumRes..........................................................3140
;       →→→ §6.6.13: @rebuildJsXfer...........................................................3152
;       →→→ §6.6.14: @commitJsXfer............................................................3164
;       →→→ §6.6.15: @rebuildJsUgr............................................................3176
;       →→→ §6.6.16: @commitJsUgr.............................................................3188
;       →→→ §6.6.17: @rebuildJsUcore..........................................................3200
;       →→→ §6.6.18: @commitJsUcore...........................................................3213
;       →→→ §6.6.19: @rebuildJsUcrAss.........................................................3225
;     >>> §6.7: FOR UPDATING JS SUBMODULES....................................................3244
;       →→→ §6.7.1: @updateJsSubmoduleAscc....................................................3247
;       →→→ §6.7.2: @updateJsSubmoduleCr......................................................3265
;       →→→ §6.7.3: @updateJsSubmoduleDsp.....................................................3283
;       →→→ §6.7.4: @updateJsSubmoduleFye.....................................................3301
;       →→→ §6.7.5: @updateJsSubmoduleFyf.....................................................3319
;       →→→ §6.7.6: @updateJsSubmoduleNse.....................................................3337
;       →→→ §6.7.7: @updateJsSubmoduleOue.....................................................3355
;       →→→ §6.7.8: @updateJsSubmodulePbk.....................................................3373
;       →→→ §6.7.9: @updateJsSubmoduleSurca...................................................3391
;       →→→ §6.7.10: @updateJsSubmoduleSumRes.................................................3409
;       →→→ §6.7.11: @updateJsSubmoduleXfer...................................................3427
;       →→→ §6.7.12: @updateJsSubmoduleUgr....................................................3445
;       →→→ §6.7.13: @updateJsSubmoduleUcore..................................................3463
;       →→→ §6.7.14: @updateJsSubmoduleUcrAss.................................................3481
;       →→→ §6.7.15: @updateJsSubmoduleAll....................................................3499
;     >>> §6.8: Shortcuts for copying minified JS to clipboard................................3526
;       →→→ §6.8.1: @copyMinJsAscc............................................................3531
;       →→→ §6.8.2: @copyMinJsCr..............................................................3542
;       →→→ §6.8.3: @copyMinJsDsp.............................................................3553
;       →→→ §6.8.4: @copyMinJsFye.............................................................3564
;       →→→ §6.8.5: @copyMinJsFyf.............................................................3575
;       →→→ §6.8.6: @copyMinJsNse.............................................................3586
;       →→→ §6.8.7: @copyMinJsOue.............................................................3597
;       →→→ §6.8.8: @copyBackupJsOue..........................................................3608
;       →→→ §6.8.9: @copyMinJsPbk.............................................................3619
;       →→→ §6.8.10: @copyMinJsSurca..........................................................3630
;       →→→ §6.8.11: @copyMinJsSumRes.........................................................3641
;       →→→ §6.8.12: @copyMinJsXfer...........................................................3652
;       →→→ §6.8.13: @copyMinJsUgr............................................................3663
;       →→→ §6.8.14: @copyMinJsUcore..........................................................3673
;       →→→ §6.8.15: @copyBackupJsUcore.......................................................3684
;       →→→ §6.8.16: @copyMinJsUcrAss.........................................................3695
;     >>> §6.9: FOR CHECKING GIT STATUS ON ALL PROJECTS ......................................3706
;   §7: KEYBOARD SHORTCUTS FOR POWERSHELL.....................................................3791
;     >>> §7.1: SHORTCUTS.....................................................................3795
;     >>> §7.2: SUPPORTING FUNCTIONS..........................................................3822
; ==================================================================================================
