...
; -----------------
; ==================================================================================================
;   §1: SETTINGS accessed via functions for this imported file.................................243
;     >>> §1.1: GetCmdForMoveToCSSFolder.......................................................247
;     >>> §1.2: GetCurrentDirFrom..............................................................262
;     >>> §1.3: GetGitHubFolder................................................................274
;     >>> §1.4: UserFolderIsSet................................................................282
;   §2: FUNCTIONS for working with GitHub Desktop..............................................296
;     >>> §2.1: ActivateGitShell...............................................................300
;     >>> §2.2: CommitAfterBuild...............................................................319
;     >>> §2.3: EscapeCommitMessage............................................................354
;     >>> §2.4: Git commit GUI — Imports.......................................................364
;       →→→ §2.4.1: For committing CSS builds..................................................367
;       →→→ §2.4.2: For committing JS builds...................................................372
;       →→→ §2.4.3: For committing any type of file............................................377
;     >>> §2.5: CopySrcFileToClipboard.........................................................382
;     >>> §2.6: IsGitShellActive...............................................................403
;     >>> §2.7: PasteTextIntoGitShell..........................................................412
;     >>> §2.8: ToEscapedPath..................................................................438
;     >>> §2.9: VerifyCopiedCode...............................................................446
;   §3: FUNCTIONS for interacting with online WEB DESIGN INTERFACES............................460
;     >>> §3.1: LoadWordPressSiteInChrome......................................................464
;   §4: GUI FUNCTIONS for handling user interactions with scripts..............................500
;     >>> §4.1: @postMinCss....................................................................504
;       →→→ §4.1.1: HandlePostCssCheckAllSites.................................................544
;       →→→ §4.1.2: HandlePostCssUncheckAllSites...............................................564
;       →→→ §4.1.3: HandlePostMinCssCancel.....................................................584
;       →→→ §4.1.4: HandlePostMinCssOK.........................................................591
;       →→→ §4.1.5: PasteMinCssToWebsite.......................................................658
;     >>> §4.2: @postBackupCss.................................................................669
;       →→→ §4.2.1: HandlePostBackupCssCheckAllSites...........................................714
;       →→→ §4.2.2: HandlePostBackupCssUncheckAllSites.........................................734
;       →→→ §4.2.3: HandlePostBackupCssCancel..................................................754
;       →→→ §4.2.4: HandlePostBackupCssOK......................................................761
;     >>> §4.3: @postMinJs.....................................................................824
;       →→→ §4.3.1: HandlePostJsCheckAllSites..................................................875
;       →→→ §4.3.2: HandlePostJsUncheckAllSites................................................895
;       →→→ §4.3.3: HandlePostMinJsCancel......................................................915
;       →→→ §4.3.4: HandlePostMinJsOK..........................................................922
;       →→→ §4.3.5: PasteMinJsToWebsite........................................................989
;   §5: UTILITY HOTSTRINGS for working with GitHub Desktop....................................1004
;     >>> §5.1: FILE COMMITTING...............................................................1008
;     >>> §5.2: STATUS CHECKING...............................................................1158
;       →→→ §5.2.1: @doGitStataus & @dogs.....................................................1161
;       →→→ §5.2.2: @doGitDiff & @dogd........................................................1181
;       →→→ §5.2.3: @doGitLog & @dogl.........................................................1201
;     >>> §5.3: Automated PASTING OF CSS into online web interfaces...........................1222
;   §6: COMMAND LINE INPUT GENERATION SHORTCUTS...............................................1386
;     >>> §6.1: Shortucts for backing up custom CSS builds....................................1391
;       →→→ §6.1.1: BackupCss.................................................................1394
;       →→→ §6.1.2: @backupCssAscc............................................................1407
;       →→→ §6.1.3: @backupCssCr..............................................................1416
;       →→→ §6.1.4: @backupCssDsp.............................................................1425
;       →→→ §6.1.5: @backupCssFye.............................................................1434
;       →→→ §6.1.6: @backupCssFyf.............................................................1451
;       →→→ §6.1.7: @backupCssNse.............................................................1469
;       →→→ §6.1.8: @backupCssOue.............................................................1486
;       →→→ §6.1.9: @backupCssPbk.............................................................1503
;       →→→ §6.1.10: @backupCssSurca..........................................................1520
;       →→→ §6.1.11: @backupCssSumRes.........................................................1537
;       →→→ §6.1.12: @backupCssXfer...........................................................1555
;       →→→ §6.1.13: @backupCssUgr............................................................1573
;       →→→ §6.1.14: @backupCssXfer...........................................................1583
;       →→→ §6.1.15: @backupCssUcrAss.........................................................1600
;       →→→ §6.1.16: @backupCssAll............................................................1618
;       →→→ §6.1.17: CopyCssFromWebsite.......................................................1641
;       →→→ §6.1.18: ExecuteCssCopyCmds.......................................................1651
;     >>> §6.2: Shortcuts for rebuilding & committing custom CSS files........................1670
;       →→→ §6.2.1: @rebuildCssHere...........................................................1673
;       →→→ §6.2.2: @rebuildCssAscc...........................................................1683
;       →→→ §6.2.3: @commitCssAscc............................................................1695
;       →→→ §6.2.4: @rebuildCssCr.............................................................1710
;       →→→ §6.2.5: @commitCssCr..............................................................1722
;       →→→ §6.2.6: @rebuildCssDsp............................................................1737
;       →→→ §6.2.7: @commitCssDsp.............................................................1749
;       →→→ §6.2.8: @rebuildCssFye............................................................1764
;       →→→ §6.2.9: @commitCssFye.............................................................1776
;       →→→ §6.2.10: @rebuildCssFyf...........................................................1792
;       →→→ §6.2.11: @commitCssFyf............................................................1804
;       →→→ §6.2.12: @rebuildCssNse...........................................................1817
;       →→→ §6.2.13: @commitCssNse............................................................1829
;       →→→ §6.2.14: @rebuildCssOue...........................................................1844
;       →→→ §6.2.15: @commitCssOue............................................................1856
;       →→→ §6.2.16: @rebuildCssPbk...........................................................1872
;       →→→ §6.2.17: @commitCssPbk............................................................1884
;       →→→ §6.2.18: @rebuildCssSurca.........................................................1900
;       →→→ §6.2.19: @commitCssSurca..........................................................1912
;       →→→ §6.2.20: @rebuildCssSumRes........................................................1927
;       →→→ §6.2.21: @commitCssSumRes.........................................................1939
;       →→→ §6.2.22: @rebuildCssXfer..........................................................1954
;       →→→ §6.2.23: @commitCssXfer...........................................................1966
;       →→→ §6.2.24: @rebuildCssUgr...........................................................1982
;       →→→ §6.2.25: @commitCssUgr............................................................1994
;       →→→ §6.2.26: @rebuildCssUcore.........................................................2009
;       →→→ §6.2.27: @commitCssUcore..........................................................2021
;       →→→ §6.2.28: @rebuildCssUcrAss........................................................2036
;       →→→ §6.2.29: @commitCssUcrAss.........................................................2048
;       →→→ §6.2.30: @rebuildCssAll...........................................................2063
;     >>> §6.3: Shortcuts for updating CSS submodules.........................................2088
;       →→→ §6.3.1: @updateCssSubmoduleAscc...................................................2091
;       →→→ §6.3.2: @updateCssSubmoduleCr.....................................................2108
;       →→→ §6.3.3: @updateCssSubmoduleDsp....................................................2125
;       →→→ §6.3.4: @updateCssSubmoduleFye....................................................2142
;       →→→ §6.3.5: @updateCssSubmoduleFyf....................................................2159
;       →→→ §6.3.6: @updateCssSubmoduleNse....................................................2176
;       →→→ §6.3.7: @updateCssSubmoduleOue....................................................2193
;       →→→ §6.3.8: @updateCssSubmodulePbk....................................................2210
;       →→→ §6.3.9: @updateCssSubmoduleSurca..................................................2227
;       →→→ §6.3.10: @updateCssSubmoduleSumRes................................................2244
;       →→→ §6.3.11: @updateCssSubmoduleXfer..................................................2261
;       →→→ §6.3.12: @updateCssSubmoduleUgr...................................................2278
;       →→→ §6.3.13: @updateCssSubmoduleUcore.................................................2295
;       →→→ §6.3.14: @updateCssSubmoduleUcrAss................................................2312
;       →→→ §6.3.15: @updateCssSubmoduleAll...................................................2329
;     >>> §6.4: For copying minified, backup css files to clipboard...........................2355
;       →→→ §6.4.1: @copyMinCssAscc...........................................................2358
;       →→→ §6.4.2: @copyBackupCssAscc........................................................2368
;       →→→ §6.4.3: @copyMinCssCr.............................................................2378
;       →→→ §6.4.4: @copyBackupCssCr..........................................................2388
;       →→→ §6.4.5: @copyMinCssDsp............................................................2398
;       →→→ §6.4.6: @copyBackupCssDsp.........................................................2408
;       →→→ §6.4.7: @copyMinCssFye............................................................2418
;       →→→ §6.4.8: @copyBackupCssFye.........................................................2430
;       →→→ §6.4.9: @copyMinCssFyf............................................................2440
;       →→→ §6.4.10: @copyBackupCssFyf........................................................2450
;       →→→ §6.4.11: @copyMinCssNse...........................................................2460
;       →→→ §6.4.12: @copyBackupCssNse........................................................2470
;       →→→ §6.4.13: @copyMinCssOue...........................................................2480
;       →→→ §6.4.14: @copyMinCssPbk...........................................................2490
;       →→→ §6.4.15: @copyBackupCssPbk........................................................2500
;       →→→ §6.4.16: @copyMinCssSurca.........................................................2510
;       →→→ §6.4.17: @copyBackupCssSurca......................................................2522
;       →→→ §6.4.18: @copyMinCssSumRes........................................................2532
;       →→→ §6.4.19: @copyBackupCssSumRes.....................................................2542
;       →→→ §6.4.20: @copyMinCssXfer..........................................................2552
;       →→→ §6.4.21: @copyBackupCssXfer.......................................................2562
;       →→→ §6.4.22: @copyMinCssUgr...........................................................2572
;       →→→ §6.4.23: @copyBackupCssUgr........................................................2583
;       →→→ §6.4.24: @copyMinCssUcore.........................................................2593
;       →→→ §6.4.25: @copyBackupCssUcore......................................................2603
;       →→→ §6.4.26: @copyMinCssUcrAss........................................................2613
;       →→→ §6.4.27: @copyBackupCssUcrAss.....................................................2623
;     >>> §6.5: FOR BACKING UP CUSTOM JS BUILDS...............................................2633
;       →→→ §6.5.1: @backupJsAscc.............................................................2636
;       →→→ §6.5.2: @backupJsCr...............................................................2651
;       →→→ §6.5.3: @backupJsDsp..............................................................2667
;       →→→ §6.5.4: @backupJsFye..............................................................2683
;       →→→ §6.5.5: @backupJsFyf..............................................................2699
;       →→→ §6.5.6: @backupJsNse..............................................................2715
;       →→→ §6.5.7: @backupJsOue..............................................................2729
;       →→→ §6.5.8: @backupJsPbk..............................................................2743
;       →→→ §6.5.9: @backupJsSurca............................................................2759
;       →→→ §6.5.10: @backupJsSumRes..........................................................2774
;       →→→ §6.5.11: @commitBackupJsSumRes....................................................2786
;       →→→ §6.5.12: @backupJsXfer............................................................2798
;       →→→ §6.5.13: @backupJsUgr.............................................................2814
;       →→→ §6.5.14: @backupJsUcore...........................................................2830
;       →→→ §6.5.15: @backupJsUcrAss..........................................................2845
;       →→→ §6.5.16: @backupJsAll.............................................................2861
;       →→→ §6.5.17: CopyJsFromWebsite........................................................2887
;       →→→ §6.5.18: ExecuteJsCopyCmds........................................................2898
;     >>> §6.6: FOR REBUILDING JS SOURCE FILES................................................2914
;       →→→ §6.6.1: @rebuildJsAscc............................................................2917
;       →→→ §6.6.2: @rebuildJsCr..............................................................2936
;       →→→ §6.6.3: @rebuildJsDsp.............................................................2955
;       →→→ §6.6.4: @commitJsDsp..............................................................2970
;       →→→ §6.6.5: @rebuildJsFye.............................................................2982
;       →→→ §6.6.6: @rebuildJsFyf.............................................................3001
;       →→→ §6.6.7: @rebuildJsNse.............................................................3020
;       →→→ §6.6.8: @rebuildJsOue.............................................................3039
;       →→→ §6.6.9: @rebuildJsPbk.............................................................3058
;       →→→ §6.6.10: @rebuildJsSurca..........................................................3077
;       →→→ §6.6.11: @rebuildJsSumRes.........................................................3096
;       →→→ §6.6.12: @commitJsSumRes..........................................................3108
;       →→→ §6.6.13: @rebuildJsXfer...........................................................3120
;       →→→ §6.6.14: @commitJsXfer............................................................3132
;       →→→ §6.6.15: @rebuildJsUgr............................................................3144
;       →→→ §6.6.16: @commitJsUgr.............................................................3156
;       →→→ §6.6.17: @rebuildJsUcore..........................................................3168
;       →→→ §6.6.18: @commitJsUcore...........................................................3181
;       →→→ §6.6.19: @rebuildJsUcrAss.........................................................3193
;     >>> §6.7: FOR UPDATING JS SUBMODULES....................................................3212
;       →→→ §6.7.1: @updateJsSubmoduleAscc....................................................3215
;       →→→ §6.7.2: @updateJsSubmoduleCr......................................................3233
;       →→→ §6.7.3: @updateJsSubmoduleDsp.....................................................3251
;       →→→ §6.7.4: @updateJsSubmoduleFye.....................................................3269
;       →→→ §6.7.5: @updateJsSubmoduleFyf.....................................................3287
;       →→→ §6.7.6: @updateJsSubmoduleNse.....................................................3305
;       →→→ §6.7.7: @updateJsSubmoduleOue.....................................................3323
;       →→→ §6.7.8: @updateJsSubmodulePbk.....................................................3341
;       →→→ §6.7.9: @updateJsSubmoduleSurca...................................................3359
;       →→→ §6.7.10: @updateJsSubmoduleSumRes.................................................3377
;       →→→ §6.7.11: @updateJsSubmoduleXfer...................................................3395
;       →→→ §6.7.12: @updateJsSubmoduleUgr....................................................3413
;       →→→ §6.7.13: @updateJsSubmoduleUcore..................................................3431
;       →→→ §6.7.14: @updateJsSubmoduleUcrAss.................................................3449
;       →→→ §6.7.15: @updateJsSubmoduleAll....................................................3467
;     >>> §6.8: Shortcuts for copying minified JS to clipboard................................3494
;       →→→ §6.8.1: @copyMinJsAscc............................................................3499
;       →→→ §6.8.2: @copyMinJsCr..............................................................3510
;       →→→ §6.8.3: @copyMinJsDsp.............................................................3521
;       →→→ §6.8.4: @copyMinJsFye.............................................................3532
;       →→→ §6.8.5: @copyMinJsFyf.............................................................3543
;       →→→ §6.8.6: @copyMinJsNse.............................................................3554
;       →→→ §6.8.7: @copyMinJsOue.............................................................3565
;       →→→ §6.8.8: @copyBackupJsOue..........................................................3576
;       →→→ §6.8.9: @copyMinJsPbk.............................................................3587
;       →→→ §6.8.10: @copyMinJsSurca..........................................................3598
;       →→→ §6.8.11: @copyMinJsSumRes.........................................................3609
;       →→→ §6.8.12: @copyMinJsXfer...........................................................3620
;       →→→ §6.8.13: @copyMinJsUgr............................................................3631
;       →→→ §6.8.14: @copyMinJsUcore..........................................................3641
;       →→→ §6.8.15: @copyBackupJsUcore.......................................................3652
;       →→→ §6.8.16: @copyMinJsUcrAss.........................................................3663
;     >>> §6.9: FOR CHECKING GIT STATUS ON ALL PROJECTS ......................................3674
;   §7: KEYBOARD SHORTCUTS FOR POWERSHELL.....................................................3759
;     >>> §7.1: SHORTCUTS.....................................................................3763
;     >>> §7.2: SUPPORTING FUNCTIONS..........................................................3790
; ==================================================================================================
