...
; ==================================================================================================
; Table of Contents  (Lines 21–252)
; ---------------------------------
;   §1: SETTINGS accessed via functions for this imported file...................................259
;     >>> §1.1: GetCmdForMoveToCSSFolder — Function..............................................263
;     >>> §1.2: GetCurrentDirFrom — Function.....................................................278
;     >>> §1.3: GetGitHubFolder — Function.......................................................290
;     >>> §1.4: UserFolderIsSet — Function.......................................................298
;   §2: FUNCTIONS for working with GitHub Desktop................................................312
;     >>> §2.1: ActivateGitShell - Function......................................................316
;     >>> §2.2: CommitAfterBuild - Function......................................................335
;     >>> §2.3: EscapeCommitMessage - Function...................................................370
;     >>> §2.4: Git commit GUI — Imports.........................................................380
;       →→→ §2.4.1: For committing CSS builds....................................................383
;       →→→ §2.4.2: For committing JS builds.....................................................388
;       →→→ §2.4.3: For committing any type of file..............................................393
;     >>> §2.5: CopySrcFileToClipboard - Function................................................398
;     >>> §2.6: IsGitShellActive - Function......................................................419
;     >>> §2.7: PasteTextIntoGitShell - Function.................................................428
;     >>> §2.8: ToEscapedPath - Function.........................................................454
;     >>> §2.9: VerifyCopiedCode - Function......................................................462
;   §3: FUNCTIONS for interacting with online WEB DESIGN INTERFACES..............................476
;     >>> §3.1: LoadWordPressSiteInChrome - Function.............................................480
;   §4: GUI FUNCTIONS for handling user interactions with scripts................................516
;     >>> §4.1: @postMinCss — Hotstring..........................................................520
;       →→→ §4.1.1: HandlePostCssCheckAllSites — Supporting function.............................560
;       →→→ §4.1.2: HandlePostCssUncheckAllSites — Supporting function...........................580
;       →→→ §4.1.3: HandlePostMinCssCancel — Supporting function.................................600
;       →→→ §4.1.4: HandlePostMinCssOK — Supporting function.....................................607
;       →→→ §4.1.5: PasteMinCssToWebsite — Supporting function...................................674
;     >>> §4.2: @postBackupCss — Hotstring.......................................................685
;       →→→ §4.2.1: HandlePostBackupCssCheckAllSites — Supporting function.......................730
;       →→→ §4.2.2: HandlePostBackupCssUncheckAllSites — Supporting function.....................750
;       →→→ §4.2.3: HandlePostBackupCssCancel — Supporting function..............................770
;       →→→ §4.2.4: HandlePostBackupCssOK — Supporting function..................................777
;     >>> §4.3: @postMinJs — Hotstring...........................................................840
;       →→→ §4.3.1: HandlePostJsCheckAllSites — Supporting function..............................891
;       →→→ §4.3.2: HandlePostJsUncheckAllSites — Supporting function............................911
;       →→→ §4.3.3: HandlePostMinJsCancel — Supporting function..................................931
;       →→→ §4.3.4: HandlePostMinJsOK — Supporting function......................................938
;       →→→ §4.3.5: PasteMinJsToWebsite — Supporting function...................................1005
;   §5: FILE SYSTEM NAVIGATION Hotstrings.......................................................1020
;     >>> §5.1: Navigation within GitHub directories............................................1024
;       →→→ §5.1.1: @gotoGhAscc.................................................................1027
;       →→→ §5.1.2: @gotoGhCr...................................................................1034
;       →→→ §5.1.3: @gotoGhDsp..................................................................1042
;       →→→ §5.1.4: @gotoGhFye..................................................................1050
;       →→→ §5.1.5: @gotoGhFyf..................................................................1057
;       →→→ §5.1.6: @gotoGhNse..................................................................1065
;       →→→ §5.1.7: @gotoGhOue..................................................................1072
;       →→→ §5.1.8: @gotoGhPbk..................................................................1079
;       →→→ §5.1.9: @gotoGhRsp..................................................................1087
;       →→→ §5.1.10: @gotoGhSurca...............................................................1095
;       →→→ §5.1.11: @gotoGhSumRes..............................................................1102
;       →→→ §5.1.12: @gotoGhXfer................................................................1110
;       →→→ §5.1.13: @gotoGhUgr.................................................................1118
;       →→→ §5.1.14: @gotoGhUcore...............................................................1126
;       →→→ §5.1.15: @gotoGhUcrAss..............................................................1133
;       →→→ §5.1.16: @gotoGhCSS.................................................................1141
;       →→→ §5.1.17: @gotoGhJS..................................................................1148
;       →→→ §5.1.18: @gotoGhAhk.................................................................1155
;       →→→ §5.1.19: cdcss......................................................................1162
;       →→→ §5.1.20: cdjs.......................................................................1167
;   §6: UTILITY HOTSTRINGS for working with GitHub Desktop......................................1172
;     >>> §6.1: FILE COMMITTING.................................................................1176
;     >>> §6.2: STATUS CHECKING.................................................................1326
;     >>> §6.3: Automated PASTING OF CSS into online web interfaces.............................1348
;   §7: COMMAND LINE INPUT GENERATION SHORTCUTS.................................................1514
;     >>> §7.1: Shortucts for backing up custom CSS builds......................................1518
;       →→→ §7.1.1: @backupCssAscc — Hotstring..................................................1521
;       →→→ §7.1.2: @backupCssCr — Hotstring....................................................1536
;       →→→ §7.1.3: @backupCssDsp — Hotstring...................................................1554
;       →→→ §7.1.4: @backupCssFye — Hotstring...................................................1572
;       →→→ §7.1.5: @backupCssFyf — Hotstring...................................................1589
;       →→→ §7.1.6: @backupCssNse — Hotstring...................................................1607
;       →→→ §7.1.7: @backupCssOue — Hotstring...................................................1624
;       →→→ §7.1.8: @backupCssPbk — Hotstring...................................................1641
;       →→→ §7.1.9: @backupCssSurca — Hotstring.................................................1658
;       →→→ §7.1.10: @backupCssSumRes — Hotstring...............................................1675
;       →→→ §7.1.11: @backupCssXfer — Hotstring.................................................1693
;       →→→ §7.1.12: @backupCssUgr — Hotstring..................................................1711
;       →→→ §7.1.13: @backupCssXfer — Hotstring.................................................1729
;       →→→ §7.1.14: @backupCssUcrAss — Hotstring...............................................1746
;       →→→ §7.1.15: @backupCssAll — Hotstring..................................................1764
;       →→→ §7.1.16: CopyCssFromWebsite — Function..............................................1787
;       →→→ §7.1.16: CopyCssFromWebsite — Function..............................................1797
;     >>> §7.2: Shortcuts for rebuilding & committing custom CSS files..........................1816
;       →→→ §7.2.1: @rebuildCssHere — Hotstring.................................................1819
;       →→→ §7.2.2: @rebuildCssAscc — Hotstring.................................................1829
;       →→→ §7.2.3: @commitCssAscc — Hotstring..................................................1841
;       →→→ §7.2.4: @rebuildCssCr — Hotstring...................................................1856
;       →→→ §7.2.5: @commitCssCr — Hotstring....................................................1868
;       →→→ §7.2.6: @rebuildCssDsp — Hotstring..................................................1883
;       →→→ §7.2.7: @commitCssDsp — Hotstring...................................................1895
;       →→→ §7.2.8: @rebuildCssFye — Hotstring..................................................1910
;       →→→ §7.2.9: @commitCssFye — Hotstring...................................................1922
;       →→→ §7.2.10: @rebuildCssFyf — Hotstring.................................................1938
;       →→→ §7.2.11: @commitCssFyf — Hotstring..................................................1950
;       →→→ §7.2.12: @rebuildCssNse — Hotstring.................................................1966
;       →→→ §7.2.13: @commitCssNse — Hotstring..................................................1978
;       →→→ §7.2.14: @rebuildCssOue — Hotstring.................................................1993
;       →→→ §7.2.15: @commitCssOue — Hotstring..................................................2005
;       →→→ §7.2.16: @rebuildCssPbk — Hotstring.................................................2021
;       →→→ §7.2.17: @commitCssPbk — Hotstring..................................................2033
;       →→→ §7.2.18: @rebuildCssSurca — Hotstring...............................................2049
;       →→→ §7.2.19: @commitCssSurca — Hotstring................................................2061
;       →→→ §7.2.20: @rebuildCssSumRes — Hotstring..............................................2076
;       →→→ §7.2.21: @commitCssSumRes — Hotstring...............................................2088
;       →→→ §7.2.22: @rebuildCssXfer — Hotstring................................................2103
;       →→→ §7.2.23: @commitCssXfer — Hotstring.................................................2115
;       →→→ §7.2.24: @rebuildCssUgr — Hotstring.................................................2131
;       →→→ §7.2.25: @commitCssUgr — Hotstring..................................................2143
;       →→→ §7.2.26: @commitCssSumRes — Hotstring...............................................2158
;       →→→ §7.2.27: @commitCssUcore — Hotstring................................................2170
;       →→→ §7.2.28: @rebuildCssUcrAss — Hotstring..............................................2185
;       →→→ §7.2.29: @commitCssUcrAss — Hotstring...............................................2197
;       →→→ §7.2.30: @rebuildCssAll — Hotstring.................................................2212
;     >>> §7.3: Shortcuts for updating CSS submodules...........................................2237
;       →→→ §7.3.1: @updateCssSubmoduleAscc — Hotstring.........................................2240
;       →→→ §7.3.2: @updateCssSubmoduleCr — Hotstring...........................................2257
;       →→→ §7.3.3: @updateCssSubmoduleDsp — Hotstring..........................................2274
;       →→→ §7.3.4: @updateCssSubmoduleFye — Hotstring..........................................2291
;       →→→ §7.3.5: @updateCssSubmoduleFyf — Hotstring..........................................2308
;       →→→ §7.3.6: @updateCssSubmoduleNse — Hotstring..........................................2325
;       →→→ §7.3.7: @updateCssSubmoduleOue — Hotstring..........................................2342
;       →→→ §7.3.8: @updateCssSubmodulePbk — Hotstring..........................................2359
;       →→→ §7.3.9: @updateCssSubmoduleSurca — Hotstring........................................2376
;       →→→ §7.3.10: @updateCssSubmoduleSumRes — Hotstring......................................2393
;       →→→ §7.3.11: @updateCssSubmoduleXfer — Hotstring........................................2410
;       →→→ §7.3.12: @updateCssSubmoduleUgr — Hotstring.........................................2427
;       →→→ §7.3.13: @updateCssSubmoduleUcore — Hotstring.......................................2444
;       →→→ §7.3.14: @updateCssSubmoduleUcrAss — Hotstring......................................2461
;       →→→ §7.3.15: @updateCssSubmoduleAll — Hotstring.........................................2478
;     >>> §7.4: For copying minified, backup css files to clipboard.............................2504
;       →→→ §7.4.1: @copyMinCssAscc — Hotstring.................................................2507
;       →→→ §7.4.2: @copyBackupCssAscc — Hotstring..............................................2519
;       →→→ §7.4.3: @copyMinCssCr — Hotstring...................................................2529
;       →→→ §7.4.4: @copyBackupCssCr — Hotstring................................................2541
;       →→→ §7.4.5: @copyMinCssDsp — Hotstring..................................................2551
;       →→→ §7.4.6: @copyBackupCssDsp — Hotstring...............................................2561
;       →→→ §7.4.7: @copyMinCssFye — Hotstring..................................................2571
;       →→→ §7.4.8: @copyBackupCssFye — Hotstring...............................................2583
;       →→→ §7.4.9: @copyMinCssFyf — Hotstring..................................................2593
;       →→→ §7.4.10: @copyBackupCssFyf — Hotstring..............................................2605
;       →→→ §7.4.11: @copyMinCssNse — Hotstring.................................................2615
;       →→→ §7.4.12: @copyBackupCssNse — Hotstring..............................................2625
;       →→→ §7.4.13: @copyMinCssOue — Hotstring.................................................2635
;       →→→ §7.4.14: @copyMinCssPbk — Hotstring.................................................2645
;       →→→ §7.4.15: @copyBackupCssPbk — Hotstring..............................................2655
;       →→→ §7.4.16: @copyMinCssSurca — Hotstring...............................................2665
;       →→→ §7.4.17: @copyBackupCssSurca — Hotstring............................................2677
;       →→→ §7.4.18: @copyMinCssSumRes — Hotstring..............................................2687
;       →→→ §7.4.19: @copyBackupCssSumRes — Hotstring...........................................2697
;       →→→ §7.4.20: @copyMinCssXfer — Hotstring................................................2707
;       →→→ §7.4.21: @copyBackupCssXfer — Hotstring.............................................2717
;       →→→ §7.4.22: @copyMinCssUgr — Hotstring.................................................2727
;       →→→ §7.4.23: @copyBackupCssUgr — Hotstring..............................................2738
;       →→→ §7.4.24: @copyMinCssUcore — Hotstring...............................................2748
;       →→→ §7.4.25: @copyBackupCssUcore — Hotstring............................................2758
;       →→→ §7.4.26: @copyMinCssUcrAss — Hotstring..............................................2768
;       →→→ §7.4.27: @copyBackupCssUcrAss — Hotstring...........................................2778
;     >>> §7.5: FOR BACKING UP CUSTOM JS BUILDS.................................................2788
;       →→→ §7.5.1: @backupJsAscc — Hotstring...................................................2791
;       →→→ §7.5.2: @backupJsCr — Hotstring.....................................................2806
;       →→→ §7.5.3: @backupJsDsp — Hotstring....................................................2822
;       →→→ §7.5.4: @backupJsFye — Hotstring....................................................2838
;       →→→ §7.5.5: @backupJsFyf — Hotstring....................................................2854
;       →→→ §7.5.6: @backupJsNse — Hotstring....................................................2870
;       →→→ §7.5.7: @backupJsOue — Hotstring....................................................2884
;       →→→ §7.5.8: @backupJsPbk — Hotstring....................................................2898
;       →→→ §7.5.9: @backupJsSurca — Hotstring..................................................2914
;       →→→ §7.5.10: @backupJsSumRes — Hotstring................................................2929
;       →→→ §7.5.11: @commitBackupJsSumRes — Hotstring..........................................2941
;       →→→ §7.5.12: @backupJsXfer — Hotstring..................................................2953
;       →→→ §7.5.13: @backupJsUgr — Hotstring...................................................2969
;       →→→ §7.5.14: @backupJsUcore — Hotstring.................................................2985
;       →→→ §7.5.15: @backupJsUcrAss — Hotstring................................................3000
;       →→→ §7.5.16: @backupJsAll — Hotstring...................................................3016
;       →→→ §7.5.17: CopyJsFromWebsite — Function...............................................3042
;       →→→ §7.5.18: ExecuteJsCopyCmds — Function...............................................3051
;     >>> §7.6: FOR REBUILDING JS SOURCE FILES..................................................3067
;       →→→ §7.6.1: @rebuildJsAscc — Hotstring..................................................3070
;       →→→ §7.6.2: @rebuildJsCr — Hotstring....................................................3089
;       →→→ §7.6.3: @rebuildJsDsp — Hotstring...................................................3108
;       →→→ §7.6.4: @commitJsDsp — Hotstring....................................................3123
;       →→→ §7.6.5: @rebuildJsFye — Hotstring...................................................3135
;       →→→ §7.6.6: @rebuildJsFyf — Hotstring...................................................3154
;       →→→ §7.6.7: @rebuildJsNse — Hotstring...................................................3173
;       →→→ §7.6.8: @rebuildJsOue — Hotstring...................................................3192
;       →→→ §7.6.9: @rebuildJsPbk — Hotstring...................................................3211
;       →→→ §7.6.10: @rebuildJsSurca — Hotstring................................................3230
;       →→→ §7.6.11: @rebuildJsSumRes — Hotstring...............................................3249
;       →→→ §7.6.12: @commitJsSumRes — Hotstring................................................3261
;       →→→ §7.6.13: @rebuildJsXfer — Hotstring.................................................3273
;       →→→ §7.6.14: @commitJsXfer — Hotstring..................................................3285
;       →→→ §7.6.15: @rebuildJsUgr — Hotstring..................................................3297
;       →→→ §7.6.16: @rebuildJsUcore — Hotstring................................................3316
;       →→→ §7.6.17: @rebuildJsUcrAss — Hotstring...............................................3335
;     >>> §7.7: FOR UPDATING JS SUBMODULES......................................................3354
;       →→→ §7.7.1: @updateJsSubmoduleAscc — Hotstring..........................................3357
;       →→→ §7.7.2: @updateJsSubmoduleCr — Hotstring............................................3375
;       →→→ §7.7.3: @updateJsSubmoduleDsp — Hotstring...........................................3393
;       →→→ §7.7.4: @updateJsSubmoduleFye — Hotstring...........................................3411
;       →→→ §7.7.5: @updateJsSubmoduleFyf — Hotstring...........................................3429
;       →→→ §7.7.6: @updateJsSubmoduleNse — Hotstring...........................................3447
;       →→→ §7.7.7: @updateJsSubmoduleOue — Hotstring...........................................3465
;       →→→ §7.7.8: @updateJsSubmodulePbk — Hotstring...........................................3483
;       →→→ §7.7.9: @updateJsSubmoduleSurca — Hotstring.........................................3501
;       →→→ §7.7.10: @updateJsSubmoduleSumRes — Hotstring.......................................3519
;       →→→ §7.7.11: @updateJsSubmoduleXfer — Hotstring.........................................3537
;       →→→ §7.7.12: @updateJsSubmoduleUgr — Hotstring..........................................3555
;       →→→ §7.7.13: @updateJsSubmoduleUcore — Hotstring........................................3573
;       →→→ §7.7.14: @updateJsSubmoduleUcrAss — Hotstring.......................................3591
;       →→→ §7.7.15: @updateJsSubmoduleAll — Hotstring..........................................3609
;     >>> §7.8: Shortcuts for copying minified JS to clipboard..................................3636
;       →→→ §7.8.1: @copyMinJsAscc — Hotstring..................................................3641
;       →→→ §7.8.2: @copyMinJsCr — Hotstring....................................................3652
;       →→→ §7.8.3: @copyMinJsDsp — Hotstring...................................................3663
;       →→→ §7.8.4: @copyMinJsFye — Hotstring...................................................3674
;       →→→ §7.8.5: @copyMinJsFyf — Hotstring...................................................3685
;       →→→ §7.8.6: @copyMinJsNse — Hotstring...................................................3696
;       →→→ §7.8.7: @copyMinJsOue — Hotstring...................................................3707
;       →→→ §7.8.8: @copyBackupJsOue — Hotstring................................................3718
;       →→→ §7.8.9: @copyMinJsPbk — Hotstring...................................................3729
;       →→→ §7.8.10: @copyMinJsSurca — Hotstring................................................3740
;       →→→ §7.8.11: @copyMinJsSumRes — Hotstring...............................................3751
;       →→→ §7.8.12: @copyMinJsXfer — Hotstring.................................................3762
;       →→→ §7.8.13: @copyMinJsUgr — Hotstring..................................................3773
;       →→→ §7.8.14: @copyMinJsUcore — Hotstring................................................3784
;       →→→ §7.8.15: @copyBackupJsUcore — Hotstring.............................................3795
;       →→→ §7.8.16: @copyMinJsUcrAss — Hotstring...............................................3806
;     >>> §7.9: FOR CHECKING GIT STATUS ON ALL PROJECTS ........................................3817
;   §8: KEYBOARD SHORTCUTS FOR POWERSHELL.......................................................3902
;     >>> §8.1: SHORTCUTS.......................................................................3906
;     >>> §8.2: SUPPORTING FUNCTIONS............................................................3932
; ==================================================================================================
...
ExecuteCssPasteCmds(manualProcession := false) {
	...
	posFound := RegExMatch(clipboard, "^@import url\(https://fonts\.googleapis\.com/css")
	if (posFound != 0) {
		Click, 768, 570
		Sleep, 100
		SendInput, ^a
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §7.6.12: @commitJsSumRes — Hotstring
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §7.6.13: @rebuildJsXfer — Hotstring
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §7.6.16: @rebuildJsUcore — Hotstring
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §7.6.17: @rebuildJsUcrAss — Hotstring
