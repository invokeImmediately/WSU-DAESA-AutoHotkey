...
;     >>> §1.2: GetCurrentDirFrom..............................................................280
;     >>> §1.3: GetGitHubFolder................................................................292
;     >>> §1.4: UserFolderIsSet................................................................300
;   §2: FUNCTIONS for working with GitHub Desktop..............................................314
;     >>> §2.1: ActivateGitShell...............................................................318
;     >>> §2.2: CommitAfterBuild...............................................................337
;     >>> §2.3: EscapeCommitMessage............................................................372
;     >>> §2.4: Git commit GUI — Imports.......................................................382
;       →→→ §2.4.1: For committing CSS builds..................................................385
;       →→→ §2.4.2: For committing JS builds...................................................390
;       →→→ §2.4.3: For committing any type of file............................................395
;     >>> §2.5: CopySrcFileToClipboard.........................................................400
;     >>> §2.6: IsGitShellActive...............................................................421
;     >>> §2.7: PasteTextIntoGitShell..........................................................428
;     >>> §2.8: ToEscapedPath..................................................................454
;     >>> §2.9: VerifyCopiedCode...............................................................462
;   §3: FUNCTIONS for interacting with online WEB DESIGN INTERFACES............................476
;     >>> §3.1: LoadWordPressSiteInChrome......................................................480
;   §4: GUI FUNCTIONS for handling user interactions with scripts..............................516
;     >>> §4.1: @postMinCss....................................................................520
;       →→→ §4.1.1: HandlePostCssCheckAllSites.................................................560
;       →→→ §4.1.2: HandlePostCssUncheckAllSites...............................................580
;       →→→ §4.1.3: HandlePostMinCssCancel.....................................................600
;       →→→ §4.1.4: HandlePostMinCssOK.........................................................607
;       →→→ §4.1.5: PasteMinCssToWebsite.......................................................674
;     >>> §4.2: @postBackupCss.................................................................685
;       →→→ §4.2.1: HandlePostBackupCssCheckAllSites...........................................730
;       →→→ §4.2.2: HandlePostBackupCssUncheckAllSites.........................................750
;       →→→ §4.2.3: HandlePostBackupCssCancel..................................................770
;       →→→ §4.2.4: HandlePostBackupCssOK......................................................777
;     >>> §4.3: @postMinJs.....................................................................840
;       →→→ §4.3.1: HandlePostJsCheckAllSites..................................................891
;       →→→ §4.3.2: HandlePostJsUncheckAllSites................................................911
;       →→→ §4.3.3: HandlePostMinJsCancel......................................................931
;       →→→ §4.3.4: HandlePostMinJsOK..........................................................938
;       →→→ §4.3.5: PasteMinJsToWebsite.......................................................1005
;   §5: UTILITY HOTSTRINGS for working with GitHub Desktop....................................1020
;     >>> §5.1: FILE COMMITTING...............................................................1024
;     >>> §5.2: STATUS CHECKING...............................................................1174
;       →→→ §5.2.1: @doGitStataus & @dogs.....................................................1177
;       →→→ §5.2.2: @doGitDiff & @dogd........................................................1197
;       →→→ §5.2.3: @doGitLog & @dogl.........................................................1217
;       →→→ §5.2.4: @doGitNoFollowLog & @donfgl...............................................1237
;     >>> §5.3: Automated PASTING OF CSS/JS into online web interfaces........................1257
;       →→→ §5.3.1: @initCssPaste.............................................................1260
;       →→→ §5.3.2: @doCssPaste...............................................................1288
;       →→→ §5.3.3: @pasteGitCommitMsg........................................................1349
;       →→→ §5.3.4: ExecuteCssPasteCmds.......................................................1365
;       →→→ §5.3.5: ExecuteJsPasteCmds........................................................1399
;   §6: COMMAND LINE INPUT GENERATION SHORTCUTS...............................................1440
;     >>> §6.1: Shortucts for backing up custom CSS builds....................................1444
;       →→→ §6.1.1: @BackupCss................................................................1447
;       →→→ §6.1.2: @backupCssAscc............................................................1460
;       →→→ §6.1.3: @backupCssCr..............................................................1469
;       →→→ §6.1.4: @backupCssDsp.............................................................1478
;       →→→ §6.1.5: @backupCssFye.............................................................1487
;       →→→ §6.1.6: @backupCssFyf.............................................................1504
;       →→→ §6.1.7: @backupCssNse.............................................................1522
;       →→→ §6.1.8: @backupCssOue.............................................................1539
;       →→→ §6.1.9: @backupCssPbk.............................................................1556
;       →→→ §6.1.10: @backupCssSurca..........................................................1573
;       →→→ §6.1.11: @backupCssSumRes.........................................................1590
;       →→→ §6.1.12: @backupCssXfer...........................................................1608
;       →→→ §6.1.13: @backupCssUgr............................................................1626
;       →→→ §6.1.14: @backupCssXfer...........................................................1636
;       →→→ §6.1.15: @backupCssUcrAss.........................................................1653
;       →→→ §6.1.16: @backupCssAll............................................................1671
;       →→→ §6.1.17: CopyCssFromWebsite.......................................................1694
;       →→→ §6.1.18: ExecuteCssCopyCmds.......................................................1704
;     >>> §6.2: Shortcuts for rebuilding & committing custom CSS files........................1723
;       →→→ §6.2.1: RebuildCss................................................................1726
;       →→→ §6.2.2: @rebuildCssHere...........................................................1738
;       →→→ §6.2.3: @rebuildCssAscc...........................................................1748
;       →→→ §6.2.4: @rebuildCssCr.............................................................1755
;       →→→ §6.2.5: @rebuildCssDsp............................................................1762
;       →→→ §6.2.6: @rebuildCssFye............................................................1769
;       →→→ §6.2.7: @rebuildCssFyf............................................................1776
;       →→→ §6.2.8: @rebuildCssNse............................................................1783
;       →→→ §6.2.9: @rebuildCssOue............................................................1790
;       →→→ §6.2.10: @rebuildCssPbk...........................................................1797
;       →→→ §6.2.11: @rebuildCssSurca.........................................................1804
;       →→→ §6.2.12: @rebuildCssSumRes........................................................1811
;       →→→ §6.2.13: @rebuildCssXfer..........................................................1818
;       →→→ §6.2.14: @rebuildCssUgr...........................................................1825
;       →→→ §6.2.15: @rebuildCssUcore.........................................................1832
;       →→→ §6.2.16: @rebuildCssUcrAss........................................................1840
;       →→→ §6.2.17: @rebuildCssAll...........................................................1848
;     >>> §6.3: Shortcuts for committing CSS builds...........................................1873
;       →→→ §6.3.1: @commitCssAscc............................................................1876
;       →→→ §6.3.2: @commitCssCr..............................................................1885
;       →→→ §6.3.3: @commitCssDsp.............................................................1894
;       →→→ §6.3.4: @commitCssFye.............................................................1903
;       →→→ §6.3.5: @commitCssFyf.............................................................1912
;       →→→ §6.3.6: @commitCssNse.............................................................1921
;       →→→ §6.3.7: @commitCssOue.............................................................1930
;       →→→ §6.3.8: @commitCssPbk.............................................................1939
;       →→→ §6.3.9: @commitCssSurca...........................................................1948
;       →→→ §6.3.10: @commitCssSumRes.........................................................1957
;       →→→ §6.3.11: @commitCssXfer...........................................................1966
;       →→→ §6.3.12: @commitCssUgr............................................................1975
;       →→→ §6.3.13: @commitCssUcore..........................................................1984
;       →→→ §6.3.14: @commitCssUcrAss.........................................................1993
;     >>> §6.4: Shortcuts for updating CSS submodules.........................................2002
;       →→→ §6.4.1: UpdateCssSubmodule........................................................2005
;       →→→ §6.4.2: @updateCssSubmoduleAscc...................................................2024
;       →→→ §6.4.3: @updateCssSubmoduleCr.....................................................2031
;       →→→ §6.4.4: @updateCssSubmoduleDsp....................................................2038
;       →→→ §6.4.5: @updateCssSubmoduleFye....................................................2045
;       →→→ §6.4.6: @updateCssSubmoduleFyf....................................................2052
;       →→→ §6.4.7: @updateCssSubmoduleNse....................................................2059
;       →→→ §6.4.8: @updateCssSubmoduleOue....................................................2066
;       →→→ §6.4.9: @updateCssSubmodulePbk....................................................2073
;       →→→ §6.4.10: @updateCssSubmoduleSurca.................................................2080
;       →→→ §6.4.11: @updateCssSubmoduleSumRes................................................2087
;       →→→ §6.4.12: @updateCssSubmoduleXfer..................................................2094
;       →→→ §6.4.13: @updateCssSubmoduleUgr...................................................2101
;       →→→ §6.4.14: @updateCssSubmoduleUcore.................................................2108
;       →→→ §6.4.15: @updateCssSubmoduleUcrAss................................................2115
;       →→→ §6.4.16: @updateCssSubmoduleAll...................................................2122
;     >>> §6.5: For copying minified, backup css files to clipboard...........................2148
;       →→→ §6.5.1: @copyMinCssAscc...........................................................2151
;       →→→ §6.5.2: @copyBackupCssAscc........................................................2161
;       →→→ §6.5.3: @copyMinCssCr.............................................................2171
;       →→→ §6.5.4: @copyBackupCssCr..........................................................2181
;       →→→ §6.5.5: @copyMinCssDsp............................................................2191
;       →→→ §6.5.6: @copyBackupCssDsp.........................................................2201
;       →→→ §6.5.7: @copyMinCssFye............................................................2211
;       →→→ §6.5.8: @copyBackupCssFye.........................................................2223
;       →→→ §6.5.9: @copyMinCssFyf............................................................2233
;       →→→ §6.5.10: @copyBackupCssFyf........................................................2243
;       →→→ §6.5.11: @copyMinCssNse...........................................................2253
;       →→→ §6.5.12: @copyBackupCssNse........................................................2263
;       →→→ §6.5.13: @copyMinCssOue...........................................................2273
;       →→→ §6.5.14: @copyMinCssPbk...........................................................2283
;       →→→ §6.5.15: @copyBackupCssPbk........................................................2293
;       →→→ §6.5.16: @copyMinCssSurca.........................................................2303
;       →→→ §6.5.17: @copyBackupCssSurca......................................................2313
;       →→→ §6.5.18: @copyMinCssSumRes........................................................2323
;       →→→ §6.5.19: @copyBackupCssSumRes.....................................................2333
;       →→→ §6.5.20: @copyMinCssXfer..........................................................2343
;       →→→ §6.5.21: @copyBackupCssXfer.......................................................2353
;       →→→ §6.5.22: @copyMinCssUgr...........................................................2363
;       →→→ §6.5.23: @copyBackupCssUgr........................................................2374
;       →→→ §6.5.24: @copyMinCssUcore.........................................................2384
;       →→→ §6.5.25: @copyBackupCssUcore......................................................2394
;       →→→ §6.5.26: @copyMinCssUcrAss........................................................2404
;       →→→ §6.5.27: @copyBackupCssUcrAss.....................................................2414
;     >>> §6.6: FOR BACKING UP CUSTOM JS BUILDS...............................................2424
;       →→→ §6.6.1: BackupJs..................................................................2427
;       →→→ §6.6.2: @backupJsAscc.............................................................2441
;       →→→ §6.6.3: @backupJsCr...............................................................2456
;       →→→ §6.6.4: @backupJsDsp..............................................................2472
;       →→→ §6.6.5: @backupJsFye..............................................................2482
;       →→→ §6.6.6: @backupJsFyf..............................................................2498
;       →→→ §6.6.7: @backupJsNse..............................................................2514
;       →→→ §6.6.8: @backupJsOue..............................................................2528
;       →→→ §6.6.9: @backupJsPbk..............................................................2542
;       →→→ §6.6.10: @backupJsSurca...........................................................2558
;       →→→ §6.6.11: @backupJsSumRes..........................................................2573
;       →→→ §6.6.12: @commitBackupJsSumRes....................................................2585
;       →→→ §6.6.13: @backupJsXfer............................................................2597
;       →→→ §6.6.14: @backupJsUgr.............................................................2607
;       →→→ §6.6.15: @backupJsUcore...........................................................2617
;       →→→ §6.6.16: @backupJsUcrAss..........................................................2632
;       →→→ §6.6.17: @backupJsAll.............................................................2648
;       →→→ §6.6.18: CopyJsFromWebsite........................................................2674
;       →→→ §6.6.19: ExecuteJsCopyCmds........................................................2685
;     >>> §6.7: FOR REBUILDING JS SOURCE FILES................................................2701
;       →→→ §6.7.1: RebuildJs.................................................................2704
;       →→→ §6.7.2: @rebuildJsAscc............................................................2715
;       →→→ §6.7.3: @rebuildJsCr..............................................................2722
;       →→→ §6.7.4: @rebuildJsDsp.............................................................2729
;       →→→ §6.7.5: @rebuildJsFye.............................................................2736
;       →→→ §6.7.6: @rebuildJsFyf.............................................................2755
;       →→→ §6.7.7: @rebuildJsNse.............................................................2774
;       →→→ §6.7.8: @rebuildJsOue.............................................................2793
;       →→→ §6.7.9: @rebuildJsPbk.............................................................2800
;       →→→ §6.7.10: @rebuildJsSurca..........................................................2819
;       →→→ §6.7.11: @rebuildJsSumRes.........................................................2826
;       →→→ §6.7.12: @rebuildJsXfer...........................................................2838
;       →→→ §6.7.13: @rebuildJsUgr............................................................2845
;       →→→ §6.7.14: @rebuildJsUcore..........................................................2857
;       →→→ §6.7.15: @rebuildJsUcrAss.........................................................2870
;     >>> §6.8: FOR UPDATING JS SUBMODULES....................................................2889
;       →→→ §6.8.1: @commitJsAscc.............................................................2892
;       →→→ §6.8.2: @commitJsCr...............................................................2901
;       →→→ §6.8.3: @commitJsDsp..............................................................2910
;       →→→ §6.8.4: @commitJsOue..............................................................2919
;       →→→ §6.8.5: @commitJsSurca............................................................2927
;       →→→ §6.8.6: @commitJsSumRes...........................................................2936
;       →→→ §6.8.7: @commitJsXfer.............................................................2945
;       →→→ §6.8.8: @commitJsUgr..............................................................2954
;       →→→ §6.8.9: @commitJsUcore............................................................2963
;       →→→ §6.8.10: @commitJsXfer............................................................2972
;     >>> §6.9: FOR UPDATING JS SUBMODULES....................................................2980
;       →→→ §6.9.1: UpdateJsSubmodule.........................................................2983
;       →→→ §6.9.2: @updateJsSubmoduleAscc....................................................3002
;       →→→ §6.9.3: @updateJsSubmoduleCr......................................................3009
;       →→→ §6.9.4: @updateJsSubmoduleDsp.....................................................3017
;       →→→ §6.9.5: @updateJsSubmoduleFye.....................................................3025
;       →→→ §6.9.6: @updateJsSubmoduleFyf.....................................................3032
;       →→→ §6.9.7: @updateJsSubmoduleNse.....................................................3040
;       →→→ §6.9.8: @updateJsSubmoduleOue.....................................................3047
;       →→→ §6.9.9: @updateJsSubmodulePbk.....................................................3054
;       →→→ §6.9.10: @updateJsSubmoduleSurca..................................................3061
;       →→→ §6.9.11: @updateJsSubmoduleSumRes.................................................3068
;       →→→ §6.9.12: @updateJsSubmoduleXfer...................................................3076
;       →→→ §6.9.13: @updateJsSubmoduleUgr....................................................3084
;       →→→ §6.9.14: @updateJsSubmoduleUcore..................................................3091
;       →→→ §6.9.15: @updateJsSubmoduleUcrAss.................................................3098
;       →→→ §6.9.16: @updateJsSubmoduleAll....................................................3106
;     >>> §6.10: Shortcuts for copying minified JS to clipboard...............................3133
;       →→→ §6.10.1: @copyMinJsAscc...........................................................3138
;       →→→ §6.10.2: @copyMinJsCr.............................................................3149
;       →→→ §6.10.3: @copyMinJsDsp............................................................3160
;       →→→ §6.10.4: @copyMinJsFye............................................................3171
;       →→→ §6.10.5: @copyMinJsFyf............................................................3182
;       →→→ §6.10.6: @copyMinJsNse............................................................3193
;       →→→ §6.10.7: @copyMinJsOue............................................................3204
;       →→→ §6.10.8: @copyBackupJsOue.........................................................3215
;       →→→ §6.10.9: @copyMinJsPbk............................................................3226
;       →→→ §6.10.10: @copyMinJsSurca.........................................................3237
;       →→→ §6.10.11: @copyMinJsSumRes........................................................3248
;       →→→ §6.10.12: @copyMinJsXfer..........................................................3259
;       →→→ §6.10.13: @copyMinJsUgr...........................................................3269
;       →→→ §6.10.14: @copyMinJsUcore.........................................................3279
;       →→→ §6.10.15: @copyBackupJsUcore......................................................3290
;       →→→ §6.10.16: @copyMinJsUcrAss........................................................3301
;     >>> §6.11: FOR CHECKING GIT STATUS ON ALL PROJECTS......................................3312
;   §7: KEYBOARD SHORTCUTS FOR POWERSHELL.....................................................3398
;     >>> §7.1: SHORTCUTS.....................................................................3402
;     >>> §7.2: SUPPORTING FUNCTIONS..........................................................3429
; ==================================================================================================
