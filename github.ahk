...
; -----------------
; ==================================================================================================
;   §1: SETTINGS accessed via functions for this imported file.................................242
;     >>> §1.1: GetCmdForMoveToCSSFolder.......................................................246
;     >>> §1.2: GetCurrentDirFrom..............................................................261
;     >>> §1.3: GetGitHubFolder................................................................273
;     >>> §1.4: UserFolderIsSet................................................................281
;   §2: FUNCTIONS for working with GitHub Desktop..............................................295
;     >>> §2.1: ActivateGitShell...............................................................299
;     >>> §2.2: CommitAfterBuild...............................................................318
;     >>> §2.3: EscapeCommitMessage............................................................353
;     >>> §2.4: Git commit GUI — Imports.......................................................363
;       →→→ §2.4.1: For committing CSS builds..................................................366
;       →→→ §2.4.2: For committing JS builds...................................................371
;       →→→ §2.4.3: For committing any type of file............................................376
;     >>> §2.5: CopySrcFileToClipboard.........................................................381
;     >>> §2.6: IsGitShellActive...............................................................402
;     >>> §2.7: PasteTextIntoGitShell..........................................................411
;     >>> §2.8: ToEscapedPath..................................................................437
;     >>> §2.9: VerifyCopiedCode...............................................................445
;   §3: FUNCTIONS for interacting with online WEB DESIGN INTERFACES............................459
;     >>> §3.1: LoadWordPressSiteInChrome......................................................463
;   §4: GUI FUNCTIONS for handling user interactions with scripts..............................499
;     >>> §4.1: @postMinCss....................................................................503
;       →→→ §4.1.1: HandlePostCssCheckAllSites.................................................543
;       →→→ §4.1.2: HandlePostCssUncheckAllSites...............................................563
;       →→→ §4.1.3: HandlePostMinCssCancel.....................................................583
;       →→→ §4.1.4: HandlePostMinCssOK.........................................................590
;       →→→ §4.1.5: PasteMinCssToWebsite.......................................................657
;     >>> §4.2: @postBackupCss.................................................................668
;       →→→ §4.2.1: HandlePostBackupCssCheckAllSites...........................................713
;       →→→ §4.2.2: HandlePostBackupCssUncheckAllSites.........................................733
;       →→→ §4.2.3: HandlePostBackupCssCancel..................................................753
;       →→→ §4.2.4: HandlePostBackupCssOK......................................................760
;     >>> §4.3: @postMinJs.....................................................................823
;       →→→ §4.3.1: HandlePostJsCheckAllSites..................................................874
;       →→→ §4.3.2: HandlePostJsUncheckAllSites................................................894
;       →→→ §4.3.3: HandlePostMinJsCancel......................................................914
;       →→→ §4.3.4: HandlePostMinJsOK..........................................................921
;       →→→ §4.3.5: PasteMinJsToWebsite........................................................988
;   §5: UTILITY HOTSTRINGS for working with GitHub Desktop....................................1003
;     >>> §5.1: FILE COMMITTING...............................................................1007
;     >>> §5.2: STATUS CHECKING...............................................................1157
;       →→→ §5.2.1: @doGitStataus & @dogs.....................................................1160
;       →→→ §5.2.2: @doGitDiff & @dogd........................................................1180
;     >>> §5.3: Automated PASTING OF CSS into online web interfaces...........................1200
;   §6: COMMAND LINE INPUT GENERATION SHORTCUTS...............................................1364
;     >>> §6.1: Shortucts for backing up custom CSS builds....................................1368
;       →→→ §6.1.1: @backupCssAscc............................................................1371
;       →→→ §6.1.2: @backupCssCr..............................................................1386
;       →→→ §6.1.3: @backupCssDsp.............................................................1404
;       →→→ §6.1.4: @backupCssFye.............................................................1422
;       →→→ §6.1.5: @backupCssFyf.............................................................1439
;       →→→ §6.1.6: @backupCssNse.............................................................1457
;       →→→ §6.1.7: @backupCssOue.............................................................1474
;       →→→ §6.1.8: @backupCssPbk.............................................................1491
;       →→→ §6.1.9: @backupCssSurca...........................................................1508
;       →→→ §6.1.10: @backupCssSumRes.........................................................1525
;       →→→ §6.1.11: @backupCssXfer...........................................................1543
;       →→→ §6.1.12: @backupCssUgr............................................................1561
;       →→→ §6.1.13: @backupCssXfer...........................................................1579
;       →→→ §6.1.14: @backupCssUcrAss.........................................................1596
;       →→→ §6.1.15: @backupCssAll............................................................1614
;       →→→ §6.1.16: CopyCssFromWebsite.......................................................1637
;       →→→ §6.1.16: CopyCssFromWebsite.......................................................1647
;     >>> §6.2: Shortcuts for rebuilding & committing custom CSS files........................1666
;       →→→ §6.2.1: @rebuildCssHere...........................................................1669
;       →→→ §6.2.2: @rebuildCssAscc...........................................................1679
;       →→→ §6.2.3: @commitCssAscc............................................................1691
;       →→→ §6.2.4: @rebuildCssCr.............................................................1706
;       →→→ §6.2.5: @commitCssCr..............................................................1718
;       →→→ §6.2.6: @rebuildCssDsp............................................................1733
;       →→→ §6.2.7: @commitCssDsp.............................................................1745
;       →→→ §6.2.8: @rebuildCssFye............................................................1760
;       →→→ §6.2.9: @commitCssFye.............................................................1772
;       →→→ §6.2.10: @rebuildCssFyf...........................................................1788
;       →→→ §6.2.11: @commitCssFyf............................................................1800
;       →→→ §6.2.12: @rebuildCssNse...........................................................1813
;       →→→ §6.2.13: @commitCssNse............................................................1825
;       →→→ §6.2.14: @rebuildCssOue...........................................................1840
;       →→→ §6.2.15: @commitCssOue............................................................1852
;       →→→ §6.2.16: @rebuildCssPbk...........................................................1868
;       →→→ §6.2.17: @commitCssPbk............................................................1880
;       →→→ §6.2.18: @rebuildCssSurca.........................................................1896
;       →→→ §6.2.19: @commitCssSurca..........................................................1908
;       →→→ §6.2.20: @rebuildCssSumRes........................................................1923
;       →→→ §6.2.21: @commitCssSumRes.........................................................1935
;       →→→ §6.2.22: @rebuildCssXfer..........................................................1950
;       →→→ §6.2.23: @commitCssXfer...........................................................1962
;       →→→ §6.2.24: @rebuildCssUgr...........................................................1978
;       →→→ §6.2.25: @commitCssUgr............................................................1990
;       →→→ §6.2.26: @rebuildCssUcore.........................................................2005
;       →→→ §6.2.27: @commitCssUcore..........................................................2017
;       →→→ §6.2.28: @rebuildCssUcrAss........................................................2032
;       →→→ §6.2.29: @commitCssUcrAss.........................................................2044
;       →→→ §6.2.30: @rebuildCssAll...........................................................2059
;     >>> §6.3: Shortcuts for updating CSS submodules.........................................2084
;       →→→ §6.3.1: @updateCssSubmoduleAscc...................................................2087
;       →→→ §6.3.2: @updateCssSubmoduleCr.....................................................2104
;       →→→ §6.3.3: @updateCssSubmoduleDsp....................................................2121
;       →→→ §6.3.4: @updateCssSubmoduleFye....................................................2138
;       →→→ §6.3.5: @updateCssSubmoduleFyf....................................................2155
;       →→→ §6.3.6: @updateCssSubmoduleNse....................................................2172
;       →→→ §6.3.7: @updateCssSubmoduleOue....................................................2189
;       →→→ §6.3.8: @updateCssSubmodulePbk....................................................2206
;       →→→ §6.3.9: @updateCssSubmoduleSurca..................................................2223
;       →→→ §6.3.10: @updateCssSubmoduleSumRes................................................2240
;       →→→ §6.3.11: @updateCssSubmoduleXfer..................................................2257
;       →→→ §6.3.12: @updateCssSubmoduleUgr...................................................2274
;       →→→ §6.3.13: @updateCssSubmoduleUcore.................................................2291
;       →→→ §6.3.14: @updateCssSubmoduleUcrAss................................................2308
;       →→→ §6.3.15: @updateCssSubmoduleAll...................................................2325
;     >>> §6.4: For copying minified, backup css files to clipboard...........................2351
;       →→→ §6.4.1: @copyMinCssAscc...........................................................2354
;       →→→ §6.4.2: @copyBackupCssAscc........................................................2364
;       →→→ §6.4.3: @copyMinCssCr.............................................................2374
;       →→→ §6.4.4: @copyBackupCssCr..........................................................2384
;       →→→ §6.4.5: @copyMinCssDsp............................................................2394
;       →→→ §6.4.6: @copyBackupCssDsp.........................................................2404
;       →→→ §6.4.7: @copyMinCssFye............................................................2414
;       →→→ §6.4.8: @copyBackupCssFye.........................................................2426
;       →→→ §6.4.9: @copyMinCssFyf............................................................2436
;       →→→ §6.4.10: @copyBackupCssFyf........................................................2446
;       →→→ §6.4.11: @copyMinCssNse...........................................................2456
;       →→→ §6.4.12: @copyBackupCssNse........................................................2466
;       →→→ §6.4.13: @copyMinCssOue...........................................................2476
;       →→→ §6.4.14: @copyMinCssPbk...........................................................2486
;       →→→ §6.4.15: @copyBackupCssPbk........................................................2496
;       →→→ §6.4.16: @copyMinCssSurca.........................................................2506
;       →→→ §6.4.17: @copyBackupCssSurca......................................................2518
;       →→→ §6.4.18: @copyMinCssSumRes........................................................2528
;       →→→ §6.4.19: @copyBackupCssSumRes.....................................................2538
;       →→→ §6.4.20: @copyMinCssXfer..........................................................2548
;       →→→ §6.4.21: @copyBackupCssXfer.......................................................2558
;       →→→ §6.4.22: @copyMinCssUgr...........................................................2568
;       →→→ §6.4.23: @copyBackupCssUgr........................................................2579
;       →→→ §6.4.24: @copyMinCssUcore.........................................................2589
;       →→→ §6.4.25: @copyBackupCssUcore......................................................2599
;       →→→ §6.4.26: @copyMinCssUcrAss........................................................2609
;       →→→ §6.4.27: @copyBackupCssUcrAss.....................................................2619
;     >>> §6.5: FOR BACKING UP CUSTOM JS BUILDS...............................................2629
;       →→→ §6.5.1: @backupJsAscc.............................................................2632
;       →→→ §6.5.2: @backupJsCr...............................................................2647
;       →→→ §6.5.3: @backupJsDsp..............................................................2663
;       →→→ §6.5.4: @backupJsFye..............................................................2679
;       →→→ §6.5.5: @backupJsFyf..............................................................2695
;       →→→ §6.5.6: @backupJsNse..............................................................2711
;       →→→ §6.5.7: @backupJsOue..............................................................2725
;       →→→ §6.5.8: @backupJsPbk..............................................................2739
;       →→→ §6.5.9: @backupJsSurca............................................................2755
;       →→→ §6.5.10: @backupJsSumRes..........................................................2770
;       →→→ §6.5.11: @commitBackupJsSumRes....................................................2782
;       →→→ §6.5.12: @backupJsXfer............................................................2794
;       →→→ §6.5.13: @backupJsUgr.............................................................2810
;       →→→ §6.5.14: @backupJsUcore...........................................................2826
;       →→→ §6.5.15: @backupJsUcrAss..........................................................2841
;       →→→ §6.5.16: @backupJsAll.............................................................2857
;       →→→ §6.5.17: CopyJsFromWebsite........................................................2883
;       →→→ §6.5.18: ExecuteJsCopyCmds........................................................2892
;     >>> §6.6: FOR REBUILDING JS SOURCE FILES................................................2908
;       →→→ §6.6.1: @rebuildJsAscc............................................................2911
;       →→→ §6.6.2: @rebuildJsCr..............................................................2930
;       →→→ §6.6.3: @rebuildJsDsp.............................................................2949
;       →→→ §6.6.4: @commitJsDsp..............................................................2964
;       →→→ §6.6.5: @rebuildJsFye.............................................................2976
;       →→→ §6.6.6: @rebuildJsFyf.............................................................2995
;       →→→ §6.6.7: @rebuildJsNse.............................................................3014
;       →→→ §6.6.8: @rebuildJsOue.............................................................3033
;       →→→ §6.6.9: @rebuildJsPbk.............................................................3052
;       →→→ §6.6.10: @rebuildJsSurca..........................................................3071
;       →→→ §6.6.11: @rebuildJsSumRes.........................................................3090
;       →→→ §6.6.12: @commitJsSumRes..........................................................3102
;       →→→ §6.6.13: @rebuildJsXfer...........................................................3114
;       →→→ §6.6.14: @commitJsXfer............................................................3126
;       →→→ §6.6.15: @rebuildJsUgr............................................................3138
;       →→→ §6.6.16: @commitJsUgr.............................................................3150
;       →→→ §6.6.17: @rebuildJsUcore..........................................................3162
;       →→→ §6.6.18: @commitJsUcore...........................................................3175
;       →→→ §6.6.19: @rebuildJsUcrAss.........................................................3187
;     >>> §6.7: FOR UPDATING JS SUBMODULES....................................................3206
;       →→→ §6.7.1: @updateJsSubmoduleAscc....................................................3209
;       →→→ §6.7.2: @updateJsSubmoduleCr......................................................3227
;       →→→ §6.7.3: @updateJsSubmoduleDsp.....................................................3245
;       →→→ §6.7.4: @updateJsSubmoduleFye.....................................................3263
;       →→→ §6.7.5: @updateJsSubmoduleFyf.....................................................3281
;       →→→ §6.7.6: @updateJsSubmoduleNse.....................................................3299
;       →→→ §6.7.7: @updateJsSubmoduleOue.....................................................3317
;       →→→ §6.7.8: @updateJsSubmodulePbk.....................................................3335
;       →→→ §6.7.9: @updateJsSubmoduleSurca...................................................3353
;       →→→ §6.7.10: @updateJsSubmoduleSumRes.................................................3371
;       →→→ §6.7.11: @updateJsSubmoduleXfer...................................................3389
;       →→→ §6.7.12: @updateJsSubmoduleUgr....................................................3407
;       →→→ §6.7.13: @updateJsSubmoduleUcore..................................................3425
;       →→→ §6.7.14: @updateJsSubmoduleUcrAss.................................................3443
;       →→→ §6.7.15: @updateJsSubmoduleAll....................................................3461
;     >>> §6.8: Shortcuts for copying minified JS to clipboard................................3488
;       →→→ §6.8.1: @copyMinJsAscc............................................................3493
;       →→→ §6.8.2: @copyMinJsCr..............................................................3504
;       →→→ §6.8.3: @copyMinJsDsp.............................................................3515
;       →→→ §6.8.4: @copyMinJsFye.............................................................3526
;       →→→ §6.8.5: @copyMinJsFyf.............................................................3537
;       →→→ §6.8.6: @copyMinJsNse.............................................................3548
;       →→→ §6.8.7: @copyMinJsOue.............................................................3559
;       →→→ §6.8.8: @copyBackupJsOue..........................................................3570
;       →→→ §6.8.9: @copyMinJsPbk.............................................................3581
;       →→→ §6.8.10: @copyMinJsSurca..........................................................3592
;       →→→ §6.8.11: @copyMinJsSumRes.........................................................3603
;       →→→ §6.8.12: @copyMinJsXfer...........................................................3614
;       →→→ §6.8.13: @copyMinJsUgr............................................................3625
;       →→→ §6.8.14: @copyMinJsUcore..........................................................3635
;       →→→ §6.8.15: @copyBackupJsUcore.......................................................3646
;       →→→ §6.8.16: @copyMinJsUcrAss.........................................................3657
;     >>> §6.9: FOR CHECKING GIT STATUS ON ALL PROJECTS ......................................3668
;   §7: KEYBOARD SHORTCUTS FOR POWERSHELL.....................................................3753
;     >>> §7.1: SHORTCUTS.....................................................................3757
;     >>> §7.2: SUPPORTING FUNCTIONS..........................................................3784
; ==================================================================================================
