...
; Table of Contents
; -----------------
;   §1: SETTINGS accessed via functions for this imported file.................................239
;     >>> §1.1: GetCmdForMoveToCSSFolder.......................................................243
;     >>> §1.2: GetCurrentDirFrom..............................................................258
;     >>> §1.3: GetGitHubFolder................................................................270
;     >>> §1.4: UserFolderIsSet................................................................278
;   §2: FUNCTIONS for working with GitHub Desktop..............................................292
;     >>> §2.1: ActivateGitShell...............................................................296
;     >>> §2.2: CommitAfterBuild...............................................................315
;     >>> §2.3: EscapeCommitMessage............................................................350
;     >>> §2.4: Git commit GUI — Imports.......................................................360
;       →→→ §2.4.1: For committing CSS builds..................................................363
;       →→→ §2.4.2: For committing JS builds...................................................368
;       →→→ §2.4.3: For committing any type of file............................................373
;     >>> §2.5: CopySrcFileToClipboard.........................................................378
;     >>> §2.6: IsGitShellActive...............................................................399
;     >>> §2.7: PasteTextIntoGitShell..........................................................408
;     >>> §2.8: ToEscapedPath..................................................................434
;     >>> §2.9: VerifyCopiedCode...............................................................442
;   §3: FUNCTIONS for interacting with online WEB DESIGN INTERFACES............................456
;     >>> §3.1: LoadWordPressSiteInChrome......................................................460
;   §4: GUI FUNCTIONS for handling user interactions with scripts..............................496
;     >>> §4.1: @postMinCss....................................................................500
;       →→→ §4.1.1: HandlePostCssCheckAllSites.................................................540
;       →→→ §4.1.2: HandlePostCssUncheckAllSites...............................................560
;       →→→ §4.1.3: HandlePostMinCssCancel.....................................................580
;       →→→ §4.1.4: HandlePostMinCssOK.........................................................587
;       →→→ §4.1.5: PasteMinCssToWebsite.......................................................654
;     >>> §4.2: @postBackupCss.................................................................665
;       →→→ §4.2.1: HandlePostBackupCssCheckAllSites...........................................710
;       →→→ §4.2.2: HandlePostBackupCssUncheckAllSites.........................................730
;       →→→ §4.2.3: HandlePostBackupCssCancel..................................................750
;       →→→ §4.2.4: HandlePostBackupCssOK......................................................757
;     >>> §4.3: @postMinJs.....................................................................820
;       →→→ §4.3.1: HandlePostJsCheckAllSites..................................................871
;       →→→ §4.3.2: HandlePostJsUncheckAllSites................................................891
;       →→→ §4.3.3: HandlePostMinJsCancel......................................................911
;       →→→ §4.3.4: HandlePostMinJsOK..........................................................918
;       →→→ §4.3.5: PasteMinJsToWebsite........................................................985
;   §5: UTILITY HOTSTRINGS for working with GitHub Desktop....................................1000
;     >>> §5.1: FILE COMMITTING...............................................................1004
;     >>> §5.2: STATUS CHECKING...............................................................1154
;     >>> §5.3: Automated PASTING OF CSS into online web interfaces...........................1176
;   §6: COMMAND LINE INPUT GENERATION SHORTCUTS...............................................1342
;     >>> §6.1: Shortucts for backing up custom CSS builds....................................1346
;       →→→ §6.1.1: @backupCssAscc............................................................1349
;       →→→ §6.1.2: @backupCssCr..............................................................1364
;       →→→ §6.1.3: @backupCssDsp.............................................................1382
;       →→→ §6.1.4: @backupCssFye.............................................................1400
;       →→→ §6.1.5: @backupCssFyf.............................................................1417
;       →→→ §6.1.6: @backupCssNse.............................................................1435
;       →→→ §6.1.7: @backupCssOue.............................................................1452
;       →→→ §6.1.8: @backupCssPbk.............................................................1469
;       →→→ §6.1.9: @backupCssSurca...........................................................1486
;       →→→ §6.1.10: @backupCssSumRes.........................................................1503
;       →→→ §6.1.11: @backupCssXfer...........................................................1521
;       →→→ §6.1.12: @backupCssUgr............................................................1539
;       →→→ §6.1.13: @backupCssXfer...........................................................1557
;       →→→ §6.1.14: @backupCssUcrAss.........................................................1574
;       →→→ §6.1.15: @backupCssAll............................................................1592
;       →→→ §6.1.16: CopyCssFromWebsite.......................................................1615
;       →→→ §6.1.16: CopyCssFromWebsite.......................................................1625
;     >>> §6.2: Shortcuts for rebuilding & committing custom CSS files........................1644
;       →→→ §6.2.1: @rebuildCssHere...........................................................1647
;       →→→ §6.2.2: @rebuildCssAscc...........................................................1657
;       →→→ §6.2.3: @commitCssAscc............................................................1669
;       →→→ §6.2.4: @rebuildCssCr.............................................................1684
;       →→→ §6.2.5: @commitCssCr..............................................................1696
;       →→→ §6.2.6: @rebuildCssDsp............................................................1711
;       →→→ §6.2.7: @commitCssDsp.............................................................1723
;       →→→ §6.2.8: @rebuildCssFye............................................................1738
;       →→→ §6.2.9: @commitCssFye.............................................................1750
;       →→→ §6.2.10: @rebuildCssFyf...........................................................1766
;       →→→ §6.2.11: @commitCssFyf............................................................1778
;       →→→ §6.2.12: @rebuildCssNse...........................................................1791
;       →→→ §6.2.13: @commitCssNse............................................................1803
;       →→→ §6.2.14: @rebuildCssOue...........................................................1818
;       →→→ §6.2.15: @commitCssOue............................................................1830
;       →→→ §6.2.16: @rebuildCssPbk...........................................................1846
;       →→→ §6.2.17: @commitCssPbk............................................................1858
;       →→→ §6.2.18: @rebuildCssSurca.........................................................1874
;       →→→ §6.2.19: @commitCssSurca..........................................................1886
;       →→→ §6.2.20: @rebuildCssSumRes........................................................1901
;       →→→ §6.2.21: @commitCssSumRes.........................................................1913
;       →→→ §6.2.22: @rebuildCssXfer..........................................................1928
;       →→→ §6.2.23: @commitCssXfer...........................................................1940
;       →→→ §6.2.24: @rebuildCssUgr...........................................................1956
;       →→→ §6.2.25: @commitCssUgr............................................................1968
;       →→→ §6.2.26: @rebuildCssUcore.........................................................1983
;       →→→ §6.2.27: @commitCssUcore..........................................................1995
;       →→→ §6.2.28: @rebuildCssUcrAss........................................................2010
;       →→→ §6.2.29: @commitCssUcrAss.........................................................2022
;       →→→ §6.2.30: @rebuildCssAll...........................................................2037
;     >>> §6.3: Shortcuts for updating CSS submodules.........................................2062
;       →→→ §6.3.1: @updateCssSubmoduleAscc...................................................2065
;       →→→ §6.3.2: @updateCssSubmoduleCr.....................................................2082
;       →→→ §6.3.3: @updateCssSubmoduleDsp....................................................2099
;       →→→ §6.3.4: @updateCssSubmoduleFye....................................................2116
;       →→→ §6.3.5: @updateCssSubmoduleFyf....................................................2133
;       →→→ §6.3.6: @updateCssSubmoduleNse....................................................2150
;       →→→ §6.3.7: @updateCssSubmoduleOue....................................................2167
;       →→→ §6.3.8: @updateCssSubmodulePbk....................................................2184
;       →→→ §6.3.9: @updateCssSubmoduleSurca..................................................2201
;       →→→ §6.3.10: @updateCssSubmoduleSumRes................................................2218
;       →→→ §6.3.11: @updateCssSubmoduleXfer..................................................2235
;       →→→ §6.3.12: @updateCssSubmoduleUgr...................................................2252
;       →→→ §6.3.13: @updateCssSubmoduleUcore.................................................2269
;       →→→ §6.3.14: @updateCssSubmoduleUcrAss................................................2286
;       →→→ §6.3.15: @updateCssSubmoduleAll...................................................2303
;     >>> §6.4: For copying minified, backup css files to clipboard...........................2329
;       →→→ §6.4.1: @copyMinCssAscc...........................................................2332
;       →→→ §6.4.2: @copyBackupCssAscc........................................................2342
;       →→→ §6.4.3: @copyMinCssCr.............................................................2352
;       →→→ §6.4.4: @copyBackupCssCr..........................................................2364
;       →→→ §6.4.5: @copyMinCssDsp............................................................2374
;       →→→ §6.4.6: @copyBackupCssDsp.........................................................2384
;       →→→ §6.4.7: @copyMinCssFye............................................................2394
;       →→→ §6.4.8: @copyBackupCssFye.........................................................2406
;       →→→ §6.4.9: @copyMinCssFyf............................................................2416
;       →→→ §6.4.10: @copyBackupCssFyf........................................................2426
;       →→→ §6.4.11: @copyMinCssNse...........................................................2436
;       →→→ §6.4.12: @copyBackupCssNse........................................................2446
;       →→→ §6.4.13: @copyMinCssOue...........................................................2456
;       →→→ §6.4.14: @copyMinCssPbk...........................................................2466
;       →→→ §6.4.15: @copyBackupCssPbk........................................................2476
;       →→→ §6.4.16: @copyMinCssSurca.........................................................2486
;       →→→ §6.4.17: @copyBackupCssSurca......................................................2498
;       →→→ §6.4.18: @copyMinCssSumRes........................................................2508
;       →→→ §6.4.19: @copyBackupCssSumRes.....................................................2518
;       →→→ §6.4.20: @copyMinCssXfer..........................................................2528
;       →→→ §6.4.21: @copyBackupCssXfer.......................................................2538
;       →→→ §6.4.22: @copyMinCssUgr...........................................................2548
;       →→→ §6.4.23: @copyBackupCssUgr........................................................2559
;       →→→ §6.4.24: @copyMinCssUcore.........................................................2569
;       →→→ §6.4.25: @copyBackupCssUcore......................................................2579
;       →→→ §6.4.26: @copyMinCssUcrAss........................................................2589
;       →→→ §6.4.27: @copyBackupCssUcrAss.....................................................2599
;     >>> §6.5: FOR BACKING UP CUSTOM JS BUILDS...............................................2609
;       →→→ §6.5.1: @backupJsAscc.............................................................2612
;       →→→ §6.5.2: @backupJsCr...............................................................2627
;       →→→ §6.5.3: @backupJsDsp..............................................................2643
;       →→→ §6.5.4: @backupJsFye..............................................................2659
;       →→→ §6.5.5: @backupJsFyf..............................................................2675
;       →→→ §6.5.6: @backupJsNse..............................................................2691
;       →→→ §6.5.7: @backupJsOue..............................................................2705
;       →→→ §6.5.8: @backupJsPbk..............................................................2719
;       →→→ §6.5.9: @backupJsSurca............................................................2735
;       →→→ §6.5.10: @backupJsSumRes..........................................................2750
;       →→→ §6.5.11: @commitBackupJsSumRes....................................................2762
;       →→→ §6.5.12: @backupJsXfer............................................................2774
;       →→→ §6.5.13: @backupJsUgr.............................................................2790
;       →→→ §6.5.14: @backupJsUcore...........................................................2806
;       →→→ §6.5.15: @backupJsUcrAss..........................................................2821
;       →→→ §6.5.16: @backupJsAll.............................................................2837
;       →→→ §6.5.17: CopyJsFromWebsite........................................................2863
;       →→→ §6.5.18: ExecuteJsCopyCmds........................................................2872
;     >>> §6.6: FOR REBUILDING JS SOURCE FILES................................................2888
;       →→→ §6.6.1: @rebuildJsAscc............................................................2891
;       →→→ §6.6.2: @rebuildJsCr..............................................................2910
;       →→→ §6.6.3: @rebuildJsDsp.............................................................2929
;       →→→ §6.6.4: @commitJsDsp..............................................................2944
;       →→→ §6.6.5: @rebuildJsFye.............................................................2956
;       →→→ §6.6.6: @rebuildJsFyf.............................................................2975
;       →→→ §6.6.7: @rebuildJsNse.............................................................2994
;       →→→ §6.6.8: @rebuildJsOue.............................................................3013
;       →→→ §6.6.9: @rebuildJsPbk.............................................................3032
;       →→→ §6.6.10: @rebuildJsSurca..........................................................3051
;       →→→ §6.6.11: @rebuildJsSumRes.........................................................3070
;       →→→ §6.6.12: @commitJsSumRes..........................................................3082
;       →→→ §6.6.13: @rebuildJsXfer...........................................................3094
;       →→→ §6.6.14: @commitJsXfer............................................................3106
;       →→→ §6.6.15: @rebuildJsUgr............................................................3118
;       →→→ §6.6.16: @commitJsUgr.............................................................3130
;       →→→ §6.6.17: @rebuildJsUcore..........................................................3142
;       →→→ §6.6.18: @commitJsUcore...........................................................3155
;       →→→ §6.6.19: @rebuildJsUcrAss.........................................................3167
;     >>> §6.7: FOR UPDATING JS SUBMODULES....................................................3186
;       →→→ §6.7.1: @updateJsSubmoduleAscc....................................................3189
;       →→→ §6.7.2: @updateJsSubmoduleCr......................................................3207
;       →→→ §6.7.3: @updateJsSubmoduleDsp.....................................................3225
;       →→→ §6.7.4: @updateJsSubmoduleFye.....................................................3243
;       →→→ §6.7.5: @updateJsSubmoduleFyf.....................................................3261
;       →→→ §6.7.6: @updateJsSubmoduleNse.....................................................3279
;       →→→ §6.7.7: @updateJsSubmoduleOue.....................................................3297
;       →→→ §6.7.8: @updateJsSubmodulePbk.....................................................3315
;       →→→ §6.7.9: @updateJsSubmoduleSurca...................................................3333
;       →→→ §6.7.10: @updateJsSubmoduleSumRes.................................................3351
;       →→→ §6.7.11: @updateJsSubmoduleXfer...................................................3369
;       →→→ §6.7.12: @updateJsSubmoduleUgr....................................................3387
;       →→→ §6.7.13: @updateJsSubmoduleUcore..................................................3405
;       →→→ §6.7.14: @updateJsSubmoduleUcrAss.................................................3423
;       →→→ §6.7.15: @updateJsSubmoduleAll....................................................3441
;     >>> §6.8: Shortcuts for copying minified JS to clipboard................................3468
;       →→→ §6.8.1: @copyMinJsAscc............................................................3473
;       →→→ §6.8.2: @copyMinJsCr..............................................................3484
;       →→→ §6.8.3: @copyMinJsDsp.............................................................3495
;       →→→ §6.8.4: @copyMinJsFye.............................................................3506
;       →→→ §6.8.5: @copyMinJsFyf.............................................................3517
;       →→→ §6.8.6: @copyMinJsNse.............................................................3528
;       →→→ §6.8.7: @copyMinJsOue.............................................................3539
;       →→→ §6.8.8: @copyBackupJsOue..........................................................3550
;       →→→ §6.8.9: @copyMinJsPbk.............................................................3561
;       →→→ §6.8.10: @copyMinJsSurca..........................................................3572
;       →→→ §6.8.11: @copyMinJsSumRes.........................................................3583
;       →→→ §6.8.12: @copyMinJsXfer...........................................................3594
;       →→→ §6.8.13: @copyMinJsUgr............................................................3605
;       →→→ §6.8.14: @copyMinJsUcore..........................................................3615
;       →→→ §6.8.15: @copyBackupJsUcore.......................................................3626
;       →→→ §6.8.16: @copyMinJsUcrAss.........................................................3637
;     >>> §6.9: FOR CHECKING GIT STATUS ON ALL PROJECTS ......................................3648
;   §7: KEYBOARD SHORTCUTS FOR POWERSHELL.....................................................3733
;     >>> §7.1: SHORTCUTS.....................................................................3737
;     >>> §7.2: SUPPORTING FUNCTIONS..........................................................3763
; ==================================================================================================
