...
;     >>> §1.1: GetCmdForMoveToCSSFolder — Function............................................241
;     >>> §1.2: GetCurrentDirFrom — Function...................................................256
;     >>> §1.3: GetGitHubFolder — Function.....................................................268
;     >>> §1.4: UserFolderIsSet — Function.....................................................276
;   §2: FUNCTIONS for working with GitHub Desktop..............................................290
;     >>> §2.1: ActivateGitShell - Function....................................................294
;     >>> §2.2: CommitAfterBuild - Function....................................................313
;     >>> §2.3: EscapeCommitMessage - Function.................................................348
;     >>> §2.4: Git commit GUI — Imports.......................................................358
;       →→→ §2.4.1: For committing CSS builds..................................................361
;       →→→ §2.4.2: For committing JS builds...................................................366
;       →→→ §2.4.3: For committing any type of file............................................371
;     >>> §2.5: CopySrcFileToClipboard - Function..............................................376
;     >>> §2.6: IsGitShellActive - Function....................................................397
;     >>> §2.7: PasteTextIntoGitShell - Function...............................................406
;     >>> §2.8: ToEscapedPath - Function.......................................................432
;     >>> §2.9: VerifyCopiedCode - Function....................................................440
;   §3: FUNCTIONS for interacting with online WEB DESIGN INTERFACES............................454
;     >>> §3.1: LoadWordPressSiteInChrome - Function...........................................458
;   §4: GUI FUNCTIONS for handling user interactions with scripts..............................494
;     >>> §4.1: @postMinCss — Hotstring........................................................498
;       →→→ §4.1.1: HandlePostCssCheckAllSites — Supporting function...........................538
;       →→→ §4.1.2: HandlePostCssUncheckAllSites — Supporting function.........................558
;       →→→ §4.1.3: HandlePostMinCssCancel — Supporting function...............................578
;       →→→ §4.1.4: HandlePostMinCssOK — Supporting function...................................585
;       →→→ §4.1.5: PasteMinCssToWebsite — Supporting function.................................652
;     >>> §4.2: @postBackupCss — Hotstring.....................................................663
;       →→→ §4.2.1: HandlePostBackupCssCheckAllSites — Supporting function.....................708
;       →→→ §4.2.2: HandlePostBackupCssUncheckAllSites — Supporting function...................728
;       →→→ §4.2.3: HandlePostBackupCssCancel — Supporting function............................748
;       →→→ §4.2.4: HandlePostBackupCssOK — Supporting function................................755
;     >>> §4.3: @postMinJs — Hotstring.........................................................818
;       →→→ §4.3.1: HandlePostJsCheckAllSites — Supporting function............................869
;       →→→ §4.3.2: HandlePostJsUncheckAllSites — Supporting function..........................889
;       →→→ §4.3.3: HandlePostMinJsCancel — Supporting function................................909
;       →→→ §4.3.4: HandlePostMinJsOK — Supporting function....................................916
;       →→→ §4.3.5: PasteMinJsToWebsite — Supporting function..................................983
;   §5: UTILITY HOTSTRINGS for working with GitHub Desktop.....................................998
;     >>> §5.1: FILE COMMITTING...............................................................1002
;     >>> §5.2: STATUS CHECKING...............................................................1152
;     >>> §5.3: Automated PASTING OF CSS into online web interfaces...........................1174
;   §6: COMMAND LINE INPUT GENERATION SHORTCUTS...............................................1340
;     >>> §6.1: Shortucts for backing up custom CSS builds....................................1344
;       →→→ §6.1.1: @backupCssAscc — Hotstring................................................1347
;       →→→ §6.1.2: @backupCssCr — Hotstring..................................................1362
;       →→→ §6.1.3: @backupCssDsp — Hotstring.................................................1380
;       →→→ §6.1.4: @backupCssFye — Hotstring.................................................1398
;       →→→ §6.1.5: @backupCssFyf — Hotstring.................................................1415
;       →→→ §6.1.6: @backupCssNse — Hotstring.................................................1433
;       →→→ §6.1.7: @backupCssOue — Hotstring.................................................1450
;       →→→ §6.1.8: @backupCssPbk — Hotstring.................................................1467
;       →→→ §6.1.9: @backupCssSurca — Hotstring...............................................1484
;       →→→ §6.1.10: @backupCssSumRes — Hotstring.............................................1501
;       →→→ §6.1.11: @backupCssXfer — Hotstring...............................................1519
;       →→→ §6.1.12: @backupCssUgr — Hotstring................................................1537
;       →→→ §6.1.13: @backupCssXfer — Hotstring...............................................1555
;       →→→ §6.1.14: @backupCssUcrAss — Hotstring.............................................1572
;       →→→ §6.1.15: @backupCssAll — Hotstring................................................1590
;       →→→ §6.1.16: CopyCssFromWebsite — Function............................................1613
;       →→→ §6.1.16: CopyCssFromWebsite — Function............................................1623
;     >>> §6.2: Shortcuts for rebuilding & committing custom CSS files........................1642
;       →→→ §6.2.1: @rebuildCssHere — Hotstring...............................................1645
;       →→→ §6.2.2: @rebuildCssAscc — Hotstring...............................................1655
;       →→→ §6.2.3: @commitCssAscc — Hotstring................................................1667
;       →→→ §6.2.4: @rebuildCssCr — Hotstring.................................................1682
;       →→→ §6.2.5: @commitCssCr — Hotstring..................................................1694
;       →→→ §6.2.6: @rebuildCssDsp — Hotstring................................................1709
;       →→→ §6.2.7: @commitCssDsp — Hotstring.................................................1721
;       →→→ §6.2.8: @rebuildCssFye — Hotstring................................................1736
;       →→→ §6.2.9: @commitCssFye — Hotstring.................................................1748
;       →→→ §6.2.10: @rebuildCssFyf — Hotstring...............................................1764
;       →→→ §6.2.11: @commitCssFyf — Hotstring................................................1776
;       →→→ §6.2.12: @rebuildCssNse — Hotstring...............................................1789
;       →→→ §6.2.13: @commitCssNse — Hotstring................................................1801
;       →→→ §6.2.14: @rebuildCssOue — Hotstring...............................................1816
;       →→→ §6.2.15: @commitCssOue — Hotstring................................................1828
;       →→→ §6.2.16: @rebuildCssPbk — Hotstring...............................................1844
;       →→→ §6.2.17: @commitCssPbk — Hotstring................................................1856
;       →→→ §6.2.18: @rebuildCssSurca — Hotstring.............................................1872
;       →→→ §6.2.19: @commitCssSurca — Hotstring..............................................1884
;       →→→ §6.2.20: @rebuildCssSumRes — Hotstring............................................1899
;       →→→ §6.2.21: @commitCssSumRes — Hotstring.............................................1911
;       →→→ §6.2.22: @rebuildCssXfer — Hotstring..............................................1926
;       →→→ §6.2.23: @commitCssXfer — Hotstring...............................................1938
;       →→→ §6.2.24: @rebuildCssUgr — Hotstring...............................................1954
;       →→→ §6.2.25: @commitCssUgr — Hotstring................................................1966
;       →→→ §6.2.26: @commitCssSumRes — Hotstring.............................................1981
;       →→→ §6.2.27: @commitCssUcore — Hotstring..............................................1993
;       →→→ §6.2.28: @rebuildCssUcrAss — Hotstring............................................2008
;       →→→ §6.2.29: @commitCssUcrAss — Hotstring.............................................2020
;       →→→ §6.2.30: @rebuildCssAll — Hotstring...............................................2035
;     >>> §6.3: Shortcuts for updating CSS submodules.........................................2060
;       →→→ §6.3.1: @updateCssSubmoduleAscc — Hotstring.......................................2063
;       →→→ §6.3.2: @updateCssSubmoduleCr — Hotstring.........................................2080
;       →→→ §6.3.3: @updateCssSubmoduleDsp — Hotstring........................................2097
;       →→→ §6.3.4: @updateCssSubmoduleFye — Hotstring........................................2114
;       →→→ §6.3.5: @updateCssSubmoduleFyf — Hotstring........................................2131
;       →→→ §6.3.6: @updateCssSubmoduleNse — Hotstring........................................2148
;       →→→ §6.3.7: @updateCssSubmoduleOue — Hotstring........................................2165
;       →→→ §6.3.8: @updateCssSubmodulePbk — Hotstring........................................2182
;       →→→ §6.3.9: @updateCssSubmoduleSurca — Hotstring......................................2199
;       →→→ §6.3.10: @updateCssSubmoduleSumRes — Hotstring....................................2216
;       →→→ §6.3.11: @updateCssSubmoduleXfer — Hotstring......................................2233
;       →→→ §6.3.12: @updateCssSubmoduleUgr — Hotstring.......................................2250
;       →→→ §6.3.13: @updateCssSubmoduleUcore — Hotstring.....................................2267
;       →→→ §6.3.14: @updateCssSubmoduleUcrAss — Hotstring....................................2284
;       →→→ §6.3.15: @updateCssSubmoduleAll — Hotstring.......................................2301
;     >>> §6.4: For copying minified, backup css files to clipboard...........................2327
;       →→→ §6.4.1: @copyMinCssAscc — Hotstring...............................................2330
;       →→→ §6.4.2: @copyBackupCssAscc — Hotstring............................................2340
;       →→→ §6.4.3: @copyMinCssCr — Hotstring.................................................2350
;       →→→ §6.4.4: @copyBackupCssCr — Hotstring..............................................2362
;       →→→ §6.4.5: @copyMinCssDsp — Hotstring................................................2372
;       →→→ §6.4.6: @copyBackupCssDsp — Hotstring.............................................2382
;       →→→ §6.4.7: @copyMinCssFye — Hotstring................................................2392
;       →→→ §6.4.8: @copyBackupCssFye — Hotstring.............................................2404
;       →→→ §6.4.9: @copyMinCssFyf — Hotstring................................................2414
;       →→→ §6.4.10: @copyBackupCssFyf — Hotstring............................................2424
;       →→→ §6.4.11: @copyMinCssNse — Hotstring...............................................2434
;       →→→ §6.4.12: @copyBackupCssNse — Hotstring............................................2444
;       →→→ §6.4.13: @copyMinCssOue — Hotstring...............................................2454
;       →→→ §6.4.14: @copyMinCssPbk — Hotstring...............................................2464
;       →→→ §6.4.15: @copyBackupCssPbk — Hotstring............................................2474
;       →→→ §6.4.16: @copyMinCssSurca — Hotstring.............................................2484
;       →→→ §6.4.17: @copyBackupCssSurca — Hotstring..........................................2496
;       →→→ §6.4.18: @copyMinCssSumRes — Hotstring............................................2506
;       →→→ §6.4.19: @copyBackupCssSumRes — Hotstring.........................................2516
;       →→→ §6.4.20: @copyMinCssXfer — Hotstring..............................................2526
;       →→→ §6.4.21: @copyBackupCssXfer — Hotstring...........................................2536
;       →→→ §6.4.22: @copyMinCssUgr — Hotstring...............................................2546
;       →→→ §6.4.23: @copyBackupCssUgr — Hotstring............................................2557
;       →→→ §6.4.24: @copyMinCssUcore — Hotstring.............................................2567
;       →→→ §6.4.25: @copyBackupCssUcore — Hotstring..........................................2577
;       →→→ §6.4.26: @copyMinCssUcrAss — Hotstring............................................2587
;       →→→ §6.4.27: @copyBackupCssUcrAss — Hotstring.........................................2597
;     >>> §6.5: FOR BACKING UP CUSTOM JS BUILDS...............................................2607
;       →→→ §6.5.1: @backupJsAscc — Hotstring.................................................2610
;       →→→ §6.5.2: @backupJsCr — Hotstring...................................................2625
;       →→→ §6.5.3: @backupJsDsp — Hotstring..................................................2641
;       →→→ §6.5.4: @backupJsFye — Hotstring..................................................2657
;       →→→ §6.5.5: @backupJsFyf — Hotstring..................................................2673
;       →→→ §6.5.6: @backupJsNse — Hotstring..................................................2689
;       →→→ §6.5.7: @backupJsOue — Hotstring..................................................2703
;       →→→ §6.5.8: @backupJsPbk — Hotstring..................................................2717
;       →→→ §6.5.9: @backupJsSurca — Hotstring................................................2733
;       →→→ §6.5.10: @backupJsSumRes — Hotstring..............................................2748
;       →→→ §6.5.11: @commitBackupJsSumRes — Hotstring........................................2760
;       →→→ §6.5.12: @backupJsXfer — Hotstring................................................2772
;       →→→ §6.5.13: @backupJsUgr — Hotstring.................................................2788
;       →→→ §6.5.14: @backupJsUcore — Hotstring...............................................2804
;       →→→ §6.5.15: @backupJsUcrAss — Hotstring..............................................2819
;       →→→ §6.5.16: @backupJsAll — Hotstring.................................................2835
;       →→→ §6.5.17: CopyJsFromWebsite — Function.............................................2861
;       →→→ §6.5.18: ExecuteJsCopyCmds — Function.............................................2870
;     >>> §6.6: FOR REBUILDING JS SOURCE FILES................................................2886
;       →→→ §6.6.1: @rebuildJsAscc — Hotstring................................................2889
;       →→→ §6.6.2: @rebuildJsCr — Hotstring..................................................2908
;       →→→ §6.6.3: @rebuildJsDsp — Hotstring.................................................2927
;       →→→ §6.6.4: @commitJsDsp — Hotstring..................................................2942
;       →→→ §6.6.5: @rebuildJsFye — Hotstring.................................................2954
;       →→→ §6.6.6: @rebuildJsFyf — Hotstring.................................................2973
;       →→→ §6.6.7: @rebuildJsNse — Hotstring.................................................2992
;       →→→ §6.6.8: @rebuildJsOue — Hotstring.................................................3011
;       →→→ §6.6.9: @rebuildJsPbk — Hotstring.................................................3030
;       →→→ §6.6.10: @rebuildJsSurca — Hotstring..............................................3049
;       →→→ §6.6.11: @rebuildJsSumRes — Hotstring.............................................3068
;       →→→ §6.6.12: @commitJsSumRes — Hotstring..............................................3080
;       →→→ §6.6.13: @rebuildJsXfer — Hotstring...............................................3092
;       →→→ §6.6.14: @commitJsXfer — Hotstring................................................3104
;       →→→ §6.6.15: @rebuildJsUgr — Hotstring................................................3116
;       →→→ §6.6.16: @rebuildJsUcore — Hotstring..............................................3135
;       →→→ §6.6.17: @rebuildJsUcrAss — Hotstring.............................................3154
;     >>> §6.7: FOR UPDATING JS SUBMODULES....................................................3173
;       →→→ §6.7.1: @updateJsSubmoduleAscc — Hotstring........................................3176
;       →→→ §6.7.2: @updateJsSubmoduleCr — Hotstring..........................................3194
;       →→→ §6.7.3: @updateJsSubmoduleDsp — Hotstring.........................................3212
;       →→→ §6.7.4: @updateJsSubmoduleFye — Hotstring.........................................3230
;       →→→ §6.7.5: @updateJsSubmoduleFyf — Hotstring.........................................3248
;       →→→ §6.7.6: @updateJsSubmoduleNse — Hotstring.........................................3266
;       →→→ §6.7.7: @updateJsSubmoduleOue — Hotstring.........................................3284
;       →→→ §6.7.8: @updateJsSubmodulePbk — Hotstring.........................................3302
;       →→→ §6.7.9: @updateJsSubmoduleSurca — Hotstring.......................................3320
;       →→→ §6.7.10: @updateJsSubmoduleSumRes — Hotstring.....................................3338
;       →→→ §6.7.11: @updateJsSubmoduleXfer — Hotstring.......................................3356
;       →→→ §6.7.12: @updateJsSubmoduleUgr — Hotstring........................................3374
;       →→→ §6.7.13: @updateJsSubmoduleUcore — Hotstring......................................3392
;       →→→ §6.7.14: @updateJsSubmoduleUcrAss — Hotstring.....................................3410
;       →→→ §6.7.15: @updateJsSubmoduleAll — Hotstring........................................3428
;     >>> §6.8: Shortcuts for copying minified JS to clipboard................................3455
;       →→→ §6.8.1: @copyMinJsAscc — Hotstring................................................3460
;       →→→ §6.8.2: @copyMinJsCr — Hotstring..................................................3471
;       →→→ §6.8.3: @copyMinJsDsp — Hotstring.................................................3482
;       →→→ §6.8.4: @copyMinJsFye — Hotstring.................................................3493
;       →→→ §6.8.5: @copyMinJsFyf — Hotstring.................................................3504
;       →→→ §6.8.6: @copyMinJsNse — Hotstring.................................................3515
;       →→→ §6.8.7: @copyMinJsOue — Hotstring.................................................3526
;       →→→ §6.8.8: @copyBackupJsOue — Hotstring..............................................3537
;       →→→ §6.8.9: @copyMinJsPbk — Hotstring.................................................3548
;       →→→ §6.8.10: @copyMinJsSurca — Hotstring..............................................3559
;       →→→ §6.8.11: @copyMinJsSumRes — Hotstring.............................................3570
;       →→→ §6.8.12: @copyMinJsXfer — Hotstring...............................................3581
;       →→→ §6.8.13: @copyMinJsUgr — Hotstring................................................3592
;       →→→ §6.8.14: @copyMinJsUcore — Hotstring..............................................3603
;       →→→ §6.8.15: @copyBackupJsUcore — Hotstring...........................................3614
;       →→→ §6.8.16: @copyMinJsUcrAss — Hotstring.............................................3625
;     >>> §6.9: FOR CHECKING GIT STATUS ON ALL PROJECTS ......................................3636
;   §7: KEYBOARD SHORTCUTS FOR POWERSHELL.....................................................3721
;     >>> §7.1: SHORTCUTS.....................................................................3725
;     >>> §7.2: SUPPORTING FUNCTIONS..........................................................3751
; ==================================================================================================
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §6.6.16: @rebuildJsUcore — Hotstring
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §6.6.17: @rebuildJsUcrAss — Hotstring
