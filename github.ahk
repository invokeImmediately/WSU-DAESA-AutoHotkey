...
; Table of Contents
; -----------------
;   §1: SETTINGS accessed via functions for this imported file.................................256
;     >>> §1.1: GetCmdForMoveToCSSFolder.......................................................260
;     >>> §1.2: GetCurrentDirFrom..............................................................275
;     >>> §1.3: GetGitHubFolder................................................................287
;     >>> §1.4: UserFolderIsSet................................................................295
;   §2: FUNCTIONS for working with GitHub Desktop..............................................309
;     >>> §2.1: ActivateGitShell...............................................................313
;     >>> §2.2: CommitAfterBuild...............................................................332
;     >>> §2.3: EscapeCommitMessage............................................................367
;     >>> §2.4: Git commit GUI — Imports.......................................................377
;       →→→ §2.4.1: For committing CSS builds..................................................380
;       →→→ §2.4.2: For committing JS builds...................................................385
;       →→→ §2.4.3: For committing any type of file............................................390
;     >>> §2.5: CopySrcFileToClipboard.........................................................395
;     >>> §2.6: IsGitShellActive...............................................................416
;     >>> §2.7: PasteTextIntoGitShell..........................................................423
;     >>> §2.8: ToEscapedPath..................................................................449
;     >>> §2.9: VerifyCopiedCode...............................................................457
;   §3: FUNCTIONS for interacting with online WEB DESIGN INTERFACES............................471
;     >>> §3.1: LoadWordPressSiteInChrome......................................................475
;   §4: GUI FUNCTIONS for handling user interactions with scripts..............................511
;     >>> §4.1: @postMinCss....................................................................515
;       →→→ §4.1.1: HandlePostCssCheckAllSites.................................................555
;       →→→ §4.1.2: HandlePostCssUncheckAllSites...............................................575
;       →→→ §4.1.3: HandlePostMinCssCancel.....................................................595
;       →→→ §4.1.4: HandlePostMinCssOK.........................................................602
;       →→→ §4.1.5: PasteMinCssToWebsite.......................................................669
;     >>> §4.2: @postBackupCss.................................................................680
;       →→→ §4.2.1: HandlePostBackupCssCheckAllSites...........................................725
;       →→→ §4.2.2: HandlePostBackupCssUncheckAllSites.........................................745
;       →→→ §4.2.3: HandlePostBackupCssCancel..................................................765
;       →→→ §4.2.4: HandlePostBackupCssOK......................................................772
;     >>> §4.3: @postMinJs.....................................................................835
;       →→→ §4.3.1: HandlePostJsCheckAllSites..................................................886
;       →→→ §4.3.2: HandlePostJsUncheckAllSites................................................906
;       →→→ §4.3.3: HandlePostMinJsCancel......................................................926
;       →→→ §4.3.4: HandlePostMinJsOK..........................................................933
;       →→→ §4.3.5: PasteMinJsToWebsite.......................................................1000
;   §5: UTILITY HOTSTRINGS for working with GitHub Desktop....................................1015
;     >>> §5.1: FILE COMMITTING...............................................................1019
;     >>> §5.2: STATUS CHECKING...............................................................1169
;       →→→ §5.2.1: @doGitStataus & @dogs.....................................................1172
;       →→→ §5.2.2: @doGitDiff & @dogd........................................................1192
;       →→→ §5.2.3: @doGitLog & @dogl.........................................................1212
;     >>> §5.3: Automated PASTING OF CSS/JS into online web interfaces........................1233
;       →→→ §5.3.1: @initCssPaste.............................................................1236
;       →→→ §5.3.2: @doCssPaste...............................................................1264
;       →→→ §5.3.3: @pasteGitCommitMsg........................................................1325
;       →→→ §5.3.4: ExecuteCssPasteCmds.......................................................1341
;       →→→ §5.3.5: ExecuteJsPasteCmds........................................................1375
;   §6: COMMAND LINE INPUT GENERATION SHORTCUTS...............................................1416
;     >>> §6.1: Shortucts for backing up custom CSS builds....................................1420
;       →→→ §6.1.1: @BackupCss................................................................1423
;       →→→ §6.1.2: @backupCssAscc............................................................1436
;       →→→ §6.1.3: @backupCssCr..............................................................1445
;       →→→ §6.1.4: @backupCssDsp.............................................................1454
;       →→→ §6.1.5: @backupCssFye.............................................................1463
;       →→→ §6.1.6: @backupCssFyf.............................................................1480
;       →→→ §6.1.7: @backupCssNse.............................................................1498
;       →→→ §6.1.8: @backupCssOue.............................................................1515
;       →→→ §6.1.9: @backupCssPbk.............................................................1532
;       →→→ §6.1.10: @backupCssSurca..........................................................1549
;       →→→ §6.1.11: @backupCssSumRes.........................................................1566
;       →→→ §6.1.12: @backupCssXfer...........................................................1584
;       →→→ §6.1.13: @backupCssUgr............................................................1602
;       →→→ §6.1.14: @backupCssXfer...........................................................1612
;       →→→ §6.1.15: @backupCssUcrAss.........................................................1629
;       →→→ §6.1.16: @backupCssAll............................................................1647
;       →→→ §6.1.17: CopyCssFromWebsite.......................................................1670
;       →→→ §6.1.18: ExecuteCssCopyCmds.......................................................1680
;     >>> §6.2: Shortcuts for rebuilding & committing custom CSS files........................1699
;       →→→ §6.2.1: @rebuildCssHere...........................................................1702
;       →→→ §6.2.2: @rebuildCssAscc...........................................................1712
;       →→→ §6.2.3: @commitCssAscc............................................................1724
;       →→→ §6.2.4: @rebuildCssCr.............................................................1739
;       →→→ §6.2.5: @commitCssCr..............................................................1751
;       →→→ §6.2.6: @rebuildCssDsp............................................................1766
;       →→→ §6.2.7: @commitCssDsp.............................................................1778
;       →→→ §6.2.8: @rebuildCssFye............................................................1793
;       →→→ §6.2.9: @commitCssFye.............................................................1805
;       →→→ §6.2.10: @rebuildCssFyf...........................................................1821
;       →→→ §6.2.11: @commitCssFyf............................................................1833
;       →→→ §6.2.12: @rebuildCssNse...........................................................1846
;       →→→ §6.2.13: @commitCssNse............................................................1858
;       →→→ §6.2.14: @rebuildCssOue...........................................................1873
;       →→→ §6.2.15: @commitCssOue............................................................1885
;       →→→ §6.2.16: @rebuildCssPbk...........................................................1901
;       →→→ §6.2.17: @commitCssPbk............................................................1913
;       →→→ §6.2.18: @rebuildCssSurca.........................................................1929
;       →→→ §6.2.19: @commitCssSurca..........................................................1941
;       →→→ §6.2.20: @rebuildCssSumRes........................................................1956
;       →→→ §6.2.21: @commitCssSumRes.........................................................1968
;       →→→ §6.2.22: @rebuildCssXfer..........................................................1983
;       →→→ §6.2.23: @commitCssXfer...........................................................1995
;       →→→ §6.2.24: @rebuildCssUgr...........................................................2011
;       →→→ §6.2.25: @commitCssUgr............................................................2023
;       →→→ §6.2.26: @rebuildCssUcore.........................................................2038
;       →→→ §6.2.27: @commitCssUcore..........................................................2050
;       →→→ §6.2.28: @rebuildCssUcrAss........................................................2065
;       →→→ §6.2.29: @commitCssUcrAss.........................................................2077
;       →→→ §6.2.30: @rebuildCssAll...........................................................2092
;     >>> §6.3: Shortcuts for updating CSS submodules.........................................2117
;       →→→ §6.3.1: UpdateCssSubmodule........................................................2120
;       →→→ §6.3.2: @updateCssSubmoduleAscc...................................................2139
;       →→→ §6.3.3: @updateCssSubmoduleCr.....................................................2146
;       →→→ §6.3.4: @updateCssSubmoduleDsp....................................................2153
;       →→→ §6.3.5: @updateCssSubmoduleFye....................................................2160
;       →→→ §6.3.6: @updateCssSubmoduleFyf....................................................2167
;       →→→ §6.3.7: @updateCssSubmoduleNse....................................................2174
;       →→→ §6.3.8: @updateCssSubmoduleOue....................................................2181
;       →→→ §6.3.9: @updateCssSubmodulePbk....................................................2188
;       →→→ §6.3.10: @updateCssSubmoduleSurca.................................................2195
;       →→→ §6.3.11: @updateCssSubmoduleSumRes................................................2202
;       →→→ §6.3.12: @updateCssSubmoduleXfer..................................................2209
;       →→→ §6.3.13: @updateCssSubmoduleUgr...................................................2216
;       →→→ §6.3.14: @updateCssSubmoduleUcore.................................................2223
;       →→→ §6.3.15: @updateCssSubmoduleUcrAss................................................2230
;       →→→ §6.3.16: @updateCssSubmoduleAll...................................................2237
;     >>> §6.4: For copying minified, backup css files to clipboard...........................2263
;       →→→ §6.4.1: @copyMinCssAscc...........................................................2266
;       →→→ §6.4.2: @copyBackupCssAscc........................................................2276
;       →→→ §6.4.3: @copyMinCssCr.............................................................2286
;       →→→ §6.4.4: @copyBackupCssCr..........................................................2296
;       →→→ §6.4.5: @copyMinCssDsp............................................................2306
;       →→→ §6.4.6: @copyBackupCssDsp.........................................................2316
;       →→→ §6.4.7: @copyMinCssFye............................................................2326
;       →→→ §6.4.8: @copyBackupCssFye.........................................................2338
;       →→→ §6.4.9: @copyMinCssFyf............................................................2348
;       →→→ §6.4.10: @copyBackupCssFyf........................................................2358
;       →→→ §6.4.11: @copyMinCssNse...........................................................2368
;       →→→ §6.4.12: @copyBackupCssNse........................................................2378
;       →→→ §6.4.13: @copyMinCssOue...........................................................2388
;       →→→ §6.4.14: @copyMinCssPbk...........................................................2398
;       →→→ §6.4.15: @copyBackupCssPbk........................................................2408
;       →→→ §6.4.16: @copyMinCssSurca.........................................................2418
;       →→→ §6.4.17: @copyBackupCssSurca......................................................2428
;       →→→ §6.4.18: @copyMinCssSumRes........................................................2438
;       →→→ §6.4.19: @copyBackupCssSumRes.....................................................2448
;       →→→ §6.4.20: @copyMinCssXfer..........................................................2458
;       →→→ §6.4.21: @copyBackupCssXfer.......................................................2468
;       →→→ §6.4.22: @copyMinCssUgr...........................................................2478
;       →→→ §6.4.23: @copyBackupCssUgr........................................................2489
;       →→→ §6.4.24: @copyMinCssUcore.........................................................2499
;       →→→ §6.4.25: @copyBackupCssUcore......................................................2509
;       →→→ §6.4.26: @copyMinCssUcrAss........................................................2519
;       →→→ §6.4.27: @copyBackupCssUcrAss.....................................................2529
;     >>> §6.5: FOR BACKING UP CUSTOM JS BUILDS...............................................2539
;       →→→ §6.5.1: BackupJs..................................................................2542
;       →→→ §6.5.2: @backupJsAscc.............................................................2556
;       →→→ §6.5.3: @backupJsCr...............................................................2571
;       →→→ §6.5.4: @backupJsDsp..............................................................2587
;       →→→ §6.5.5: @backupJsFye..............................................................2597
;       →→→ §6.5.6: @backupJsFyf..............................................................2613
;       →→→ §6.5.7: @backupJsNse..............................................................2629
;       →→→ §6.5.8: @backupJsOue..............................................................2643
;       →→→ §6.5.9: @backupJsPbk..............................................................2657
;       →→→ §6.5.10: @backupJsSurca...........................................................2673
;       →→→ §6.5.11: @backupJsSumRes..........................................................2688
;       →→→ §6.5.12: @commitBackupJsSumRes....................................................2700
;       →→→ §6.5.13: @backupJsXfer............................................................2712
;       →→→ §6.5.14: @backupJsUgr.............................................................2722
;       →→→ §6.5.15: @backupJsUcore...........................................................2732
;       →→→ §6.5.16: @backupJsUcrAss..........................................................2747
;       →→→ §6.5.17: @backupJsAll.............................................................2763
;       →→→ §6.5.18: CopyJsFromWebsite........................................................2789
;       →→→ §6.5.19: ExecuteJsCopyCmds........................................................2800
;     >>> §6.6: FOR REBUILDING JS SOURCE FILES................................................2816
;       →→→ §6.6.1: RebuildJs.................................................................2819
;       →→→ §6.6.2: @rebuildJsAscc............................................................2829
;       →→→ §6.6.3: @rebuildJsCr..............................................................2836
;       →→→ §6.6.4: @rebuildJsDsp.............................................................2855
;       →→→ §6.6.5: @rebuildJsFye.............................................................2870
;       →→→ §6.6.6: @rebuildJsFyf.............................................................2889
;       →→→ §6.6.7: @rebuildJsNse.............................................................2908
;       →→→ §6.6.8: @rebuildJsOue.............................................................2927
;       →→→ §6.6.9: @rebuildJsPbk.............................................................2946
;       →→→ §6.6.10: @rebuildJsSurca..........................................................2965
;       →→→ §6.6.11: @rebuildJsSumRes.........................................................2972
;       →→→ §6.6.12: @rebuildJsXfer...........................................................2984
;       →→→ §6.6.13: @rebuildJsUgr............................................................2991
;       →→→ §6.6.14: @rebuildJsUcore..........................................................3003
;       →→→ §6.6.15: @rebuildJsUcrAss.........................................................3016
;     >>> §6.7: FOR UPDATING JS SUBMODULES....................................................3035
;       →→→ §6.7.1: @commitJsAscc.............................................................3038
;       →→→ §6.7.2: @commitJsDsp..............................................................3047
;       →→→ §6.7.3: @commitJsSurca............................................................3056
;       →→→ §6.7.4: @commitJsSumRes...........................................................3065
;       →→→ §6.7.5: @commitJsXfer.............................................................3074
;       →→→ §6.7.6: @commitJsUgr..............................................................3083
;       →→→ §6.7.7: @commitJsUcore............................................................3092
;       →→→ §6.7.8: @commitJsXfer.............................................................3101
;     >>> §6.8: FOR UPDATING JS SUBMODULES....................................................3109
;       →→→ §6.8.1: UpdateJsSubmodule.........................................................3112
;       →→→ §6.8.2: @updateJsSubmoduleAscc....................................................3126
;       →→→ §6.8.3: @updateJsSubmoduleCr......................................................3133
;       →→→ §6.8.4: @updateJsSubmoduleDsp.....................................................3141
;       →→→ §6.8.5: @updateJsSubmoduleFye.....................................................3149
;       →→→ §6.8.6: @updateJsSubmoduleFyf.....................................................3156
;       →→→ §6.8.7: @updateJsSubmoduleNse.....................................................3164
;       →→→ §6.8.8: @updateJsSubmoduleOue.....................................................3171
;       →→→ §6.8.9: @updateJsSubmodulePbk.....................................................3178
;       →→→ §6.8.10: @updateJsSubmoduleSurca..................................................3185
;       →→→ §6.8.11: @updateJsSubmoduleSumRes.................................................3192
;       →→→ §6.8.12: @updateJsSubmoduleXfer...................................................3200
;       →→→ §6.8.13: @updateJsSubmoduleUgr....................................................3208
;       →→→ §6.8.14: @updateJsSubmoduleUcore..................................................3215
;       →→→ §6.8.15: @updateJsSubmoduleUcrAss.................................................3222
;       →→→ §6.8.16: @updateJsSubmoduleAll....................................................3230
;     >>> §6.9: Shortcuts for copying minified JS to clipboard................................3257
;       →→→ §6.9.1: @copyMinJsAscc............................................................3262
;       →→→ §6.9.2: @copyMinJsCr..............................................................3273
;       →→→ §6.9.3: @copyMinJsDsp.............................................................3284
;       →→→ §6.9.4: @copyMinJsFye.............................................................3295
;       →→→ §6.9.5: @copyMinJsFyf.............................................................3306
;       →→→ §6.9.6: @copyMinJsNse.............................................................3317
;       →→→ §6.9.7: @copyMinJsOue.............................................................3328
;       →→→ §6.9.8: @copyBackupJsOue..........................................................3339
;       →→→ §6.9.9: @copyMinJsPbk.............................................................3350
;       →→→ §6.9.10: @copyMinJsSurca..........................................................3361
;       →→→ §6.9.11: @copyMinJsSumRes.........................................................3372
;       →→→ §6.9.12: @copyMinJsXfer...........................................................3383
;       →→→ §6.9.13: @copyMinJsUgr............................................................3393
;       →→→ §6.9.14: @copyMinJsUcore..........................................................3403
;       →→→ §6.9.15: @copyBackupJsUcore.......................................................3414
;       →→→ §6.9.16: @copyMinJsUcrAss.........................................................3425
;     >>> §6.10: FOR CHECKING GIT STATUS ON ALL PROJECTS .....................................3436
;   §7: KEYBOARD SHORTCUTS FOR POWERSHELL.....................................................3522
;     >>> §7.1: SHORTCUTS.....................................................................3526
;     >>> §7.2: SUPPORTING FUNCTIONS..........................................................3553
; ==================================================================================================
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §6.3.10: @updateCssSubmoduleSurca
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §6.3.11: @updateCssSubmoduleSumRes
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §6.3.14: @updateCssSubmoduleUcore
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §6.3.15: @updateCssSubmoduleUcrAss
...
:*:@rebuildJsXfer::
	RebuildJs(A_ThisLabel, GetGitHubFolder() . "\transfercredit.wsu.edu\", ":*:@commitJsXfer")
Return
