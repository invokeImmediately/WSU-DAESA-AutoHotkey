...
; Table of Contents
; -----------------
;   §1: SETTINGS accessed via functions for this imported file.................................253
;     >>> §1.1: GetCmdForMoveToCSSFolder.......................................................257
;     >>> §1.2: GetCurrentDirFrom..............................................................272
;     >>> §1.3: GetGitHubFolder................................................................284
;     >>> §1.4: UserFolderIsSet................................................................292
;   §2: FUNCTIONS for working with GitHub Desktop..............................................306
;     >>> §2.1: ActivateGitShell...............................................................310
;     >>> §2.2: CommitAfterBuild...............................................................329
;     >>> §2.3: EscapeCommitMessage............................................................364
;     >>> §2.4: Git commit GUI — Imports.......................................................374
;       →→→ §2.4.1: For committing CSS builds..................................................377
;       →→→ §2.4.2: For committing JS builds...................................................382
;       →→→ §2.4.3: For committing any type of file............................................387
;     >>> §2.5: CopySrcFileToClipboard.........................................................392
;     >>> §2.6: IsGitShellActive...............................................................413
;     >>> §2.7: PasteTextIntoGitShell..........................................................422
;     >>> §2.8: ToEscapedPath..................................................................448
;     >>> §2.9: VerifyCopiedCode...............................................................456
;   §3: FUNCTIONS for interacting with online WEB DESIGN INTERFACES............................470
;     >>> §3.1: LoadWordPressSiteInChrome......................................................474
;   §4: GUI FUNCTIONS for handling user interactions with scripts..............................510
;     >>> §4.1: @postMinCss....................................................................514
;       →→→ §4.1.1: HandlePostCssCheckAllSites.................................................554
;       →→→ §4.1.2: HandlePostCssUncheckAllSites...............................................574
;       →→→ §4.1.3: HandlePostMinCssCancel.....................................................594
;       →→→ §4.1.4: HandlePostMinCssOK.........................................................601
;       →→→ §4.1.5: PasteMinCssToWebsite.......................................................668
;     >>> §4.2: @postBackupCss.................................................................679
;       →→→ §4.2.1: HandlePostBackupCssCheckAllSites...........................................724
;       →→→ §4.2.2: HandlePostBackupCssUncheckAllSites.........................................744
;       →→→ §4.2.3: HandlePostBackupCssCancel..................................................764
;       →→→ §4.2.4: HandlePostBackupCssOK......................................................771
;     >>> §4.3: @postMinJs.....................................................................834
;       →→→ §4.3.1: HandlePostJsCheckAllSites..................................................885
;       →→→ §4.3.2: HandlePostJsUncheckAllSites................................................905
;       →→→ §4.3.3: HandlePostMinJsCancel......................................................925
;       →→→ §4.3.4: HandlePostMinJsOK..........................................................932
;       →→→ §4.3.5: PasteMinJsToWebsite........................................................999
;   §5: UTILITY HOTSTRINGS for working with GitHub Desktop....................................1014
;     >>> §5.1: FILE COMMITTING...............................................................1018
;     >>> §5.2: STATUS CHECKING...............................................................1168
;       →→→ §5.2.1: @doGitStataus & @dogs.....................................................1171
;       →→→ §5.2.2: @doGitDiff & @dogd........................................................1191
;       →→→ §5.2.3: @doGitLog & @dogl.........................................................1211
;     >>> §5.3: Automated PASTING OF CSS/JS into online web interfaces........................1232
;       →→→ §5.3.1: @initCssPaste.............................................................1235
;       →→→ §5.3.2: @doCssPaste...............................................................1263
;       →→→ §5.3.3: @pasteGitCommitMsg........................................................1324
;       →→→ §5.3.4: ExecuteCssPasteCmds.......................................................1340
;       →→→ §5.3.5: ExecuteJsPasteCmds........................................................1374
;   §6: COMMAND LINE INPUT GENERATION SHORTCUTS...............................................1415
;     >>> §6.1: Shortucts for backing up custom CSS builds....................................1419
;       →→→ §6.1.1: @BackupCss................................................................1422
;       →→→ §6.1.2: @backupCssAscc............................................................1435
;       →→→ §6.1.3: @backupCssCr..............................................................1444
;       →→→ §6.1.4: @backupCssDsp.............................................................1453
;       →→→ §6.1.5: @backupCssFye.............................................................1462
;       →→→ §6.1.6: @backupCssFyf.............................................................1479
;       →→→ §6.1.7: @backupCssNse.............................................................1497
;       →→→ §6.1.8: @backupCssOue.............................................................1514
;       →→→ §6.1.9: @backupCssPbk.............................................................1531
;       →→→ §6.1.10: @backupCssSurca..........................................................1548
;       →→→ §6.1.11: @backupCssSumRes.........................................................1565
;       →→→ §6.1.12: @backupCssXfer...........................................................1583
;       →→→ §6.1.13: @backupCssUgr............................................................1601
;       →→→ §6.1.14: @backupCssXfer...........................................................1611
;       →→→ §6.1.15: @backupCssUcrAss.........................................................1628
;       →→→ §6.1.16: @backupCssAll............................................................1646
;       →→→ §6.1.17: CopyCssFromWebsite.......................................................1669
;       →→→ §6.1.18: ExecuteCssCopyCmds.......................................................1679
;     >>> §6.2: Shortcuts for rebuilding & committing custom CSS files........................1698
;       →→→ §6.2.1: @rebuildCssHere...........................................................1701
;       →→→ §6.2.2: @rebuildCssAscc...........................................................1711
;       →→→ §6.2.3: @commitCssAscc............................................................1723
;       →→→ §6.2.4: @rebuildCssCr.............................................................1738
;       →→→ §6.2.5: @commitCssCr..............................................................1750
;       →→→ §6.2.6: @rebuildCssDsp............................................................1765
;       →→→ §6.2.7: @commitCssDsp.............................................................1777
;       →→→ §6.2.8: @rebuildCssFye............................................................1792
;       →→→ §6.2.9: @commitCssFye.............................................................1804
;       →→→ §6.2.10: @rebuildCssFyf...........................................................1820
;       →→→ §6.2.11: @commitCssFyf............................................................1832
;       →→→ §6.2.12: @rebuildCssNse...........................................................1845
;       →→→ §6.2.13: @commitCssNse............................................................1857
;       →→→ §6.2.14: @rebuildCssOue...........................................................1872
;       →→→ §6.2.15: @commitCssOue............................................................1884
;       →→→ §6.2.16: @rebuildCssPbk...........................................................1900
;       →→→ §6.2.17: @commitCssPbk............................................................1912
;       →→→ §6.2.18: @rebuildCssSurca.........................................................1928
;       →→→ §6.2.19: @commitCssSurca..........................................................1940
;       →→→ §6.2.20: @rebuildCssSumRes........................................................1955
;       →→→ §6.2.21: @commitCssSumRes.........................................................1967
;       →→→ §6.2.22: @rebuildCssXfer..........................................................1982
;       →→→ §6.2.23: @commitCssXfer...........................................................1994
;       →→→ §6.2.24: @rebuildCssUgr...........................................................2010
;       →→→ §6.2.25: @commitCssUgr............................................................2022
;       →→→ §6.2.26: @rebuildCssUcore.........................................................2037
;       →→→ §6.2.27: @commitCssUcore..........................................................2049
;       →→→ §6.2.28: @rebuildCssUcrAss........................................................2064
;       →→→ §6.2.29: @commitCssUcrAss.........................................................2076
;       →→→ §6.2.30: @rebuildCssAll...........................................................2091
;     >>> §6.3: Shortcuts for updating CSS submodules.........................................2116
;       →→→ §6.3.1: @updateCssSubmoduleAscc...................................................2119
;       →→→ §6.3.2: @updateCssSubmoduleCr.....................................................2136
;       →→→ §6.3.3: @updateCssSubmoduleDsp....................................................2153
;       →→→ §6.3.4: @updateCssSubmoduleFye....................................................2170
;       →→→ §6.3.5: @updateCssSubmoduleFyf....................................................2187
;       →→→ §6.3.6: @updateCssSubmoduleNse....................................................2204
;       →→→ §6.3.7: @updateCssSubmoduleOue....................................................2221
;       →→→ §6.3.8: @updateCssSubmodulePbk....................................................2238
;       →→→ §6.3.9: @updateCssSubmoduleSurca..................................................2255
;       →→→ §6.3.10: @updateCssSubmoduleSumRes................................................2272
;       →→→ §6.3.11: @updateCssSubmoduleXfer..................................................2289
;       →→→ §6.3.12: @updateCssSubmoduleUgr...................................................2306
;       →→→ §6.3.13: @updateCssSubmoduleUcore.................................................2323
;       →→→ §6.3.14: @updateCssSubmoduleUcrAss................................................2340
;       →→→ §6.3.15: @updateCssSubmoduleAll...................................................2357
;     >>> §6.4: For copying minified, backup css files to clipboard...........................2383
;       →→→ §6.4.1: @copyMinCssAscc...........................................................2386
;       →→→ §6.4.2: @copyBackupCssAscc........................................................2396
;       →→→ §6.4.3: @copyMinCssCr.............................................................2406
;       →→→ §6.4.4: @copyBackupCssCr..........................................................2416
;       →→→ §6.4.5: @copyMinCssDsp............................................................2426
;       →→→ §6.4.6: @copyBackupCssDsp.........................................................2436
;       →→→ §6.4.7: @copyMinCssFye............................................................2446
;       →→→ §6.4.8: @copyBackupCssFye.........................................................2458
;       →→→ §6.4.9: @copyMinCssFyf............................................................2468
;       →→→ §6.4.10: @copyBackupCssFyf........................................................2478
;       →→→ §6.4.11: @copyMinCssNse...........................................................2488
;       →→→ §6.4.12: @copyBackupCssNse........................................................2498
;       →→→ §6.4.13: @copyMinCssOue...........................................................2508
;       →→→ §6.4.14: @copyMinCssPbk...........................................................2518
;       →→→ §6.4.15: @copyBackupCssPbk........................................................2528
;       →→→ §6.4.16: @copyMinCssSurca.........................................................2538
;       →→→ §6.4.17: @copyBackupCssSurca......................................................2548
;       →→→ §6.4.18: @copyMinCssSumRes........................................................2558
;       →→→ §6.4.19: @copyBackupCssSumRes.....................................................2568
;       →→→ §6.4.20: @copyMinCssXfer..........................................................2578
;       →→→ §6.4.21: @copyBackupCssXfer.......................................................2588
;       →→→ §6.4.22: @copyMinCssUgr...........................................................2598
;       →→→ §6.4.23: @copyBackupCssUgr........................................................2609
;       →→→ §6.4.24: @copyMinCssUcore.........................................................2619
;       →→→ §6.4.25: @copyBackupCssUcore......................................................2629
;       →→→ §6.4.26: @copyMinCssUcrAss........................................................2639
;       →→→ §6.4.27: @copyBackupCssUcrAss.....................................................2649
;     >>> §6.5: FOR BACKING UP CUSTOM JS BUILDS...............................................2659
;       →→→ §6.5.1: BackupJs..................................................................2662
;       →→→ §6.5.2: @backupJsAscc.............................................................2676
;       →→→ §6.5.3: @backupJsCr...............................................................2691
;       →→→ §6.5.4: @backupJsDsp..............................................................2707
;       →→→ §6.5.5: @backupJsFye..............................................................2717
;       →→→ §6.5.6: @backupJsFyf..............................................................2733
;       →→→ §6.5.7: @backupJsNse..............................................................2749
;       →→→ §6.5.8: @backupJsOue..............................................................2763
;       →→→ §6.5.9: @backupJsPbk..............................................................2777
;       →→→ §6.5.10: @backupJsSurca...........................................................2793
;       →→→ §6.5.11: @backupJsSumRes..........................................................2808
;       →→→ §6.5.12: @commitBackupJsSumRes....................................................2820
;       →→→ §6.5.13: @backupJsXfer............................................................2832
;       →→→ §6.5.14: @backupJsUgr.............................................................2848
;       →→→ §6.5.15: @backupJsUcore...........................................................2858
;       →→→ §6.5.16: @backupJsUcrAss..........................................................2873
;       →→→ §6.5.17: @backupJsAll.............................................................2889
;       →→→ §6.5.18: CopyJsFromWebsite........................................................2915
;       →→→ §6.5.19: ExecuteJsCopyCmds........................................................2926
;     >>> §6.6: FOR REBUILDING JS SOURCE FILES................................................2942
;       →→→ §6.6.1: RebuildJs.................................................................2945
;       →→→ §6.6.2: @rebuildJsAscc............................................................2955
;       →→→ §6.6.3: @rebuildJsCr..............................................................2962
;       →→→ §6.6.4: @rebuildJsDsp.............................................................2981
;       →→→ §6.6.5: @rebuildJsFye.............................................................2996
;       →→→ §6.6.6: @rebuildJsFyf.............................................................3015
;       →→→ §6.6.7: @rebuildJsNse.............................................................3034
;       →→→ §6.6.8: @rebuildJsOue.............................................................3053
;       →→→ §6.6.9: @rebuildJsPbk.............................................................3072
;       →→→ §6.6.10: @rebuildJsSurca..........................................................3091
;       →→→ §6.6.11: @rebuildJsSumRes.........................................................3098
;       →→→ §6.6.12: @rebuildJsXfer...........................................................3110
;       →→→ §6.6.13: @rebuildJsUgr............................................................3122
;       →→→ §6.6.14: @rebuildJsUcore..........................................................3134
;       →→→ §6.6.15: @rebuildJsUcrAss.........................................................3147
;     >>> §6.7: FOR UPDATING JS SUBMODULES....................................................3166
;       →→→ §6.7.1: @commitJsAscc.............................................................3169
;       →→→ §6.7.2: @commitJsDsp..............................................................3178
;       →→→ §6.7.3: @commitJsSurca............................................................3187
;       →→→ §6.7.4: @commitJsSumRes...........................................................3196
;       →→→ §6.7.5: @commitJsXfer.............................................................3205
;       →→→ §6.7.6: @commitJsUgr..............................................................3214
;       →→→ §6.7.7: @commitJsUcore............................................................3223
;     >>> §6.8: FOR UPDATING JS SUBMODULES....................................................3232
;       →→→ §6.8.1: @updateJsSubmoduleAscc....................................................3235
;       →→→ §6.8.2: @updateJsSubmoduleCr......................................................3253
;       →→→ §6.8.3: @updateJsSubmoduleDsp.....................................................3271
;       →→→ §6.8.4: @updateJsSubmoduleFye.....................................................3289
;       →→→ §6.8.5: @updateJsSubmoduleFyf.....................................................3307
;       →→→ §6.8.6: @updateJsSubmoduleNse.....................................................3325
;       →→→ §6.8.7: @updateJsSubmoduleOue.....................................................3343
;       →→→ §6.8.8: @updateJsSubmodulePbk.....................................................3361
;       →→→ §6.8.9: @updateJsSubmoduleSurca...................................................3379
;       →→→ §6.8.10: @updateJsSubmoduleSumRes.................................................3397
;       →→→ §6.8.11: @updateJsSubmoduleXfer...................................................3415
;       →→→ §6.8.12: @updateJsSubmoduleUgr....................................................3433
;       →→→ §6.8.13: @updateJsSubmoduleUcore..................................................3451
;       →→→ §6.8.14: @updateJsSubmoduleUcrAss.................................................3469
;       →→→ §6.8.15: @updateJsSubmoduleAll....................................................3487
;     >>> §6.9: Shortcuts for copying minified JS to clipboard................................3514
;       →→→ §6.9.1: @copyMinJsAscc............................................................3519
;       →→→ §6.9.2: @copyMinJsCr..............................................................3530
;       →→→ §6.9.3: @copyMinJsDsp.............................................................3541
;       →→→ §6.9.4: @copyMinJsFye.............................................................3552
;       →→→ §6.9.5: @copyMinJsFyf.............................................................3563
;       →→→ §6.9.6: @copyMinJsNse.............................................................3574
;       →→→ §6.9.7: @copyMinJsOue.............................................................3585
;       →→→ §6.9.8: @copyBackupJsOue..........................................................3596
;       →→→ §6.9.9: @copyMinJsPbk.............................................................3607
;       →→→ §6.9.10: @copyMinJsSurca..........................................................3618
;       →→→ §6.9.11: @copyMinJsSumRes.........................................................3629
;       →→→ §6.9.12: @copyMinJsXfer...........................................................3640
;       →→→ §6.9.13: @copyMinJsUgr............................................................3651
;       →→→ §6.9.14: @copyMinJsUcore..........................................................3661
;       →→→ §6.9.15: @copyBackupJsUcore.......................................................3672
;       →→→ §6.9.16: @copyMinJsUcrAss.........................................................3683
;     >>> §6.10: FOR CHECKING GIT STATUS ON ALL PROJECTS .....................................3694
;   §7: KEYBOARD SHORTCUTS FOR POWERSHELL.....................................................3779
;     >>> §7.1: SHORTCUTS.....................................................................3783
;     >>> §7.2: SUPPORTING FUNCTIONS..........................................................3810
; ==================================================================================================
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §6.8.10: @updateJsSubmoduleSumRes
...
;      · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · ·
;       →→→ §6.8.14: @updateJsSubmoduleUcrAss
