...
; Table of Contents
; ------------------------------------------------------------------------------------------------
;   §1: Window state checks.....................................................................84
;     >>> §1.1: isTargetProcessActive...........................................................88
;     >>> §1.2: areTargetProcessActive.........................................................100
;   §2: Variable state checks..................................................................123
;     >>> §2.1: doesVarExist...................................................................127
;     >>> §2.2: isVarEmpty.....................................................................134
;     >>> §2.3: isVarDeclared..................................................................141
;   §3: Error reporting........................................................................148
;     >>> §3.1: ErrorBox.......................................................................152
;   §4: Operating system manipulation..........................................................159
;     >>> §4.1: Functions......................................................................163
;       →→→ §4.1.1: DismissSplashText..........................................................166
;       →→→ §4.1.2: DisplaySplashText..........................................................173
;       →→→ §4.1.3: FallbackWinActivate........................................................181
;       →→→ §4.1.4: GetActiveWindowBorderWidths................................................199
;       →→→ §4.1.5: GetCursorCoordsToCenterInActiveWindow......................................227
;       →→→ §4.1.6: InsertFilePath.............................................................237
;       →→→ §4.1.7: LaunchApplicationPatiently.................................................266
;       →→→ §4.1.8: LaunchStdApplicationPatiently..............................................298
;       →→→ §4.1.9: MoveCursorIntoActiveWindow.................................................330
;       →→→ §4.1.10: PasteText.................................................................348
;       →→→ §4.1.11: RemoveMinMaxStateForActiveWin.............................................359
;       →→→ §4.1.12: SafeWinActivate...........................................................370
;       →→→ §4.1.13: WaitForApplicationPatiently...............................................399
;       →→→ §4.1.14: WriteCodeToFile...........................................................420
;     >>> §4.2: Hotkeys........................................................................444
;       →→→ §4.2.1: ^+F1, ^!Numpad1............................................................448
;       →→→ §4.2.2: ^+F2, ^!Numpad2............................................................457
;       →→→ §4.2.3: ^!q........................................................................468
;     >>> §4.3: Hotstrings.....................................................................478
;       →→→ §4.3.1: @getMousePos...............................................................481
;       →→→ §4.3.2: @getWinBorders.............................................................491
;       →→→ §4.3.3: @getWinExStyle.............................................................505
;       →→→ §4.3.4: @getWinHwnd................................................................515
;       →→→ §4.5.: @getWinInfo.................................................................524
;       →→→ §4.3.6: @getWinPID.................................................................544
;       →→→ §4.3.7: @getWinPos.................................................................553
;       →→→ §4.3.8: @getWinStyle...............................................................563
;       →→→ §4.3.9: @getWinProcess.............................................................573
;       →→→ §4.3.10: @getWinTitle..............................................................585
;   §5: AutoHotkey state inquiry and manipulation..............................................594
;     >>> §5.1: Functions......................................................................598
;       →→→ §5.1.1: ChangeMatchMode............................................................601
;       →→→ §5.1.2: GetDelay...................................................................614
;       →→→ §5.1.3: RestoreMatchMode...........................................................659
;     >>> §5.2: Hotstrings.....................................................................669
;       →→→ §5.2.1: @checkIsUnicode............................................................672
;       →→→ §5.2.2: @getCurrentVersion.........................................................681
;       →→→ §5.2.3: @getLastHotStrTime.........................................................689
;   §6: Sorting functions......................................................................697
;     >>> §6.1: InsertionSort..................................................................701
;     >>> §6.2: Merge..........................................................................727
;     >>> §6.3: MergeSort......................................................................753
;     >>> §6.4: SwapValues.....................................................................769
;   §7: Desktop management functions...........................................................778
;     >>> §7.1: Functions......................................................................782
;       →→→ §7.1.1: AddWinBordersToMonitorWorkArea.............................................785
;       →→→ §7.1.2: ClipActiveWindowToMonitor..................................................800
;       →→→ §7.1.3: FindActiveMonitor..........................................................832
;       →→→ §7.1.4: FindNearestActiveMonitor...................................................852
;       →→→ §7.1.5: GetActiveMonitorWorkArea...................................................879
;       →→→ §7.1.6: RemoveWinBorderFromRectCoordinate..........................................920
;       →→→ §7.1.8: ResolveActiveMonitorWorkArea...............................................959
;     >>> §7.2: Hotstrings.....................................................................994
;       →→→ §7.2.1: @clipActiveWindowToMonitor.................................................997
; ==================================================================================================
...
GetDelay(delayLength, multiplier := 0) {
	...
	; Process delayLength into a delay value
	if (delayLength == "xShort") {
	...
	; Apply multiplier to delay, if necessary
	if (multiplier > 0) {
		delay *= multiplier
